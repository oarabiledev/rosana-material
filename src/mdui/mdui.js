...
!(function (e, t) {
    "object" == typeof exports && "undefined" != typeof module
        ...
        ? define(["exports"], t)
        : t(((e = "undefined" != typeof globalThis ? globalThis : e || self).mdui = {}));
})(this, function (e) {
    "use strict";
    function t(e) {
    ...
    function i(e = {}, o = {}) {
        Object.keys(o).forEach((n) => {
            void 0 === e[n]
                ? (e[n] = o[n])
                : t(o[n]) && t(e[n]) && Object.keys(o[n]).length > 0 && i(e[n], o[n]);
        });
    }
    const o = {
        body: {},
    ...
    const a = (e, t) => e?.nodeName.toLowerCase() === t.toLowerCase(),
        ...
        k = (e) =>
            e ? e.replace(/^./, e[0].toLowerCase()).replace(/[A-Z]/g, (e) => "-" + e.toLowerCase()) : e,
        C = () => !1,
        x = () => !0,
        $ = (e, t) => {
            for (let i = 0; i < e.length; i += 1) if (!1 === t.call(e[i], e[i], i)) return e;
            return e;
        },
        R = (e, t) => {
            ...
            const e = function (t) {
                ...
                if (l(t)) {
                    ...
                    return (
                        S(i)
                            ? t.call(i, e)
                            : i.addEventListener("DOMContentLoaded", () => t.call(i, e), { once: !0 }),
                        new I([i])
                    );
                }
                if (c(t)) {
                    ...
                    if (e.startsWith("<") && e.endsWith(">")) {
                        ...
                        return (
                            R(
                                ...
                                (i, o) => {
                                    if (e.startsWith(`<${i}`)) return (t = o), !1;
                                }
                            ),
                            new I(A(e, t))
                        );
                ...
                return !g(t) || ((i = t), "undefined" != typeof Node && i instanceof Node)
                    ? new I([t])
                    : new I(t);
                var i;
            };
        ...
        $(["add", "remove", "toggle"], (e) => {
            M.fn[`${e}Class`] = function (t) {
                return "remove" !== e || arguments.length
                    ? this.each((i, o) => {
                          if (!v(o)) return;
                          const n = (l(t) ? t.call(o, i, _(o, "class", "")) : t).split(" ").filter((e) => e);
                          $(n, (t) => {
                              o.classList[e](t);
                          });
                      })
        ...
        M.fn[e] = function (...e) {
            return (
                ...
                this.each((i, o) => {
                    ...
                    $(n, (e) => {
                        let n;
                        (n = ((e) => c(e) && !(e.startsWith("<") && e.endsWith(">")))(e)
                            ? M(A(e, "div"))
                            : i && v(e)
                            ? M(e.cloneNode(!0))
                            : M(e)),
    ...
    const F = (e, t) => s().getComputedStyle(e).getPropertyValue(k(t)),
        ...
        H = (e, t, i) => {
            ...
            return [0, 1].reduce((t, n, r) => {
                let s = i + o[r];
                return "border" === i && (s += "Width"), t + parseFloat(F(e, s) || "0");
            }, 0);
        },
        U = (e, t) => {
            if ("width" === t || "height" === t) {
            ...
            return this.each((e, r) => {
                ((e, i, o) => {
                    ...
                    (i = k(i)),
                        e.style.setProperty(
                            i,
                            d(o) ? `${o}${i.startsWith("--") || K.includes(i) ? "" : "px"}` : o
                        );
            ...
            if (u(i) && 1 === e.nodeType && ((i = e.dataset[t]), c(i)))
                try {
                    i = ((e) =>
                        "true" === e ||
                        ("false" !== e &&
                            ("null" === e ? null : e === +e + "" ? +e : J.test(e) ? JSON.parse(e) : e)))(i);
                } catch (e) {}
            return i;
        };
    ...
    const ee = (e, t, i, o, n, r) => {
            ...
            return (
                2 === o && n && (i += s("margin")),
                V(e)
                    ? (0 === o && (i -= s("border")), 1 === o && ((i -= s("border")), (i -= s("padding"))))
                    : (0 === o && (i += s("padding")), 2 === o && ((i += s("border")), (i += s("padding")))),
                i
            );
        },
        te = (e, t, i, o) => {
                ...
                return n
                    ? this.each((o, n) =>
                          ((e, t, i, o, n, r) => {
                              ...
                              const a = M(e),
                                  d = i.toLowerCase();
                              if (c(s) && ["auto", "inherit", ""].includes(s)) return void a.css(d, s);
                              const h = s.toString().replace(/\b[0-9.]*/, ""),
                                  u = parseFloat(s);
                              (s = ee(e, i, u, o, n, -1) + (h || "px")), a.css(d, s);
                          })(n, o, e, i, r, t)
                      )
                    : this.length
                    ? te(this[0], e, i, r)
                    ...
                    ? this.each((n, r) => {
                          ...
                          0 === t && Array.isArray(a)
                              ? s.is("select[multiple]")
                                  ? N(s.find("option"), (e) => (e.selected = a.includes(e.value)))
                          ...
                          ((e, t, i, o) => {
                              ...
                              return le(e).filter(
                                  (e) =>
                                      ...
                                      (!n.namespace || de(n.namespace).test(e.namespace)) &&
                                      (!i || se(e.func) === se(i)) &&
                                      (!o || e.selector === o)
                              );
                          })(e, t, i, o).forEach((e) => {
    ...
    (M.fn.off = function (e, t, i) {
        ...
        (M.fn.offsetParent = function () {
            ...
            return this.map(function () {
                ...
                for (; t && "static" === M(t).css("position"); ) t = t.offsetParent;
    ...
    M.fn.position = function () {
        ...
        if ("fixed" === e.css("position")) t = e[0].getBoundingClientRect();
            ...
            (i = o.offset()), (i.top += pe(o, "border-top-width")), (i.left += pe(o, "border-left-width"));
        }
        return { top: t.top - i.top - pe(e, "margin-top"), left: t.left - i.left - pe(e, "margin-left") };
    };
    const me = (e) => {
    ...
    (M.fn.offset = function (e) {
        ...
        return this.each(function (t) {
            ((e, t, i) => {
                ...
                const r = me(e),
                    ...
                    a = o.css("left");
                let c, d;
                if (("absolute" !== n && "fixed" !== n) || !(s + a).includes("auto"))
        ...
        (M.fn.on = function (e, t, i, o, n) {
            ...
            if (
                (null == i && null == o
                    ? ((o = t), (i = t = void 0))
                    : null == o && (c(t) ? ((o = i), (i = void 0)) : ((o = i), (i = t), (t = void 0))),
                !1 === o)
            )
                o = C;
                ...
                ((e, t, i, o, n) => {
                    ...
                    b(o) && o.useCapture && (r = !0),
                        t.split(" ").forEach((t) => {
                            ...
                            const s = ce(t),
                                a = (e, t) => {
                                    !1 === i.apply(t, null === e.detail ? [e] : [e].concat(e.detail)) &&
                                        (e.preventDefault(), e.stopPropagation());
                                },
                                l = (t) => {
                                    (t.namespace && !de(t.namespace).test(s.namespace)) ||
                                        ((t.data = o),
                                        n
                                            ? M(e)
                                                  .find(n)
    ...
    (M.fn.removeData = function (e) {
        ...
        (M.fn.replaceWith = function (e) {
            return (
                this.each((t, i) => {
                    let o = e;
                    l(o) ? (o = o.call(i, t, i.innerHTML)) : t && !c(o) && (o = M(o).clone()), M(i).before(o);
                }),
                this.remove()
            );
        }),
        (M.fn.replaceAll = function (e) {
            return M(e).map((e, t) => (M(t).replaceWith(e ? this.clone() : this), this.get()));
        });
    const ve = (e) => {
            ...
            const t = [],
                i = (e, o) => {
                    ...
                    b(o)
                        ? R(o, (t, r) => {
                              (n = Array.isArray(o) && !b(r) ? "" : t), i(`${e}[${n}]`, r);
                          })
                        : ((n = null == o || "" === o ? "=" : `=${encodeURIComponent(o)}`),
                          t.push(encodeURIComponent(e) + n));
                };
            return Array.isArray(e) ? $(e, ({ name: e, value: t }) => i(e, t)) : R(e, i), t.join("&");
        },
        ge = new WeakMap(),
        be = (e) =>
            [...[...e.elements], ...(ge.get(e) || [])].sort((e, t) =>
                e.compareDocumentPosition(t) & Node.DOCUMENT_POSITION_FOLLOWING ? -1 : 1
            ),
        ye = (e) => {
            const t = [];
            return (
                e.each((e, i) => {
                    ...
                    M(o).each((e, i) => {
                        ...
                        "fieldset" === r ||
                            ...
                            ["submit", "button", "image", "reset", "file"].includes(n) ||
                            (["radio", "checkbox"].includes(n) && !i.checked) ||
                            (["mdui-checkbox", "mdui-switch"].includes(r) && !i.checked) ||
    ...
    (M.fn.serializeArray = function () {
        return ye(this)
            .map((e) => (Array.isArray(e.value) ? e.value.map((t) => ({ name: e.name, value: t })) : e))
            .flat();
    }),
            ...
            return (
                ye(this).forEach((t) => {
                    ...
                    if (e.hasOwnProperty(i)) {
                        const t = e[i];
                        Array.isArray(t) || (e[i] = [t]), Array.isArray(o) ? e[i].push(...o) : e[i].push(o);
                    } else e[i] = o;
                }),
                e
            );
        ...
        Ie = (e) => {
            ...
            const r = {},
                ...
                l = ((e) => {
                    ...
                    return (
                        R($e, (e, i) => {
                            ["beforeSend", "success", "error", "complete", "statusCode"].includes(e) ||
                                u(i) ||
                                (t[e] = i);
                        }),
                        ue({}, t, e)
                ...
                return new Promise((t, n) => {
                    ...
                    if (
                        ...
                        (m.onload = () => {
                                ...
                                if (
                                    ((e =
                                        204 === m.status || "HEAD" === d
                                            ...
                                            : "success"),
                                    "json" === C ||
                                        (!C && (m.getResponseHeader("content-type") || "").includes("json")))
                                ) {
                                    try {
                                        (n = "HEAD" === d ? void 0 : JSON.parse(m.responseText)),
                                            (a.response = n);
                                    } catch (t) {
                                        (e = "parsererror"), T(Ce, "error", m, e), c(e);
                                    }
                                    "parsererror" !== e && (T(ke, "success", n, e, m), t(n));
                                } else
                                    (n =
                                        "HEAD" === d
                                            ? void 0
                                            : "text" === m.responseType || "" === m.responseType
                                            ? m.responseText
                                            : m.response),
                                        (a.response = n),
                                        T(ke, "success", n, e, m),
                            ...
                            $([$e.statusCode ?? {}, k], (t) => {
                                t[m.status] && (i ? t[m.status](n, e, m) : t[m.status](m, e));
                            }),
                                T(xe, "complete", m, e);
                        }),
                        (m.onerror = () => {
    ...
    function Se(e, t, i, o) {
        var n,
            r = arguments.length,
            s = r < 3 ? t : null === o ? (o = Object.getOwnPropertyDescriptor(t, i)) : o;
        if ("object" == typeof Reflect && "function" == typeof Reflect.decorate)
            s = Reflect.decorate(e, t, i, o);
        else
            for (var a = e.length - 1; a >= 0; a--)
                (n = e[a]) && (s = (r < 3 ? n(s) : r > 3 ? n(t, i, s) : n(t, i)) || s);
        return r > 3 && s && Object.defineProperty(t, i, s), s;
    }
    (M.ajaxSetup = (e) => ue($e, e)),
        (M.contains = Q),
        (M.data = function (e, t, i) {
            return b(t) ? (Y(e, t), t) : u(i) ? (u(t) ? W(e) : G(e, t)) : (X(e, t, i), i);
        }),
        (M.each = z),
    ...
    let Me = class {
        ...
        get styleSheet() {
            ...
            if (Te && void 0 === e) {
                ...
                i && (e = Ae.get(t)),
                    void 0 === e &&
                        ((this.o = e = new CSSStyleSheet()).replaceSync(this.cssText), i && Ae.set(t, e));
            }
            return e;
        }
        toString() {
    ...
    const Pe = (e, ...t) => {
            ...
            : (e) =>
                  e instanceof CSSStyleSheet
                      ? ((e) => {
                            ...
                            return ((e) => new Me("string" == typeof e ? e : e + "", void 0, De))(t);
                        })(e)
                      : e,
        {
            is: _e,
        ...
        We = (e, t) => !_e(e, t),
        Ge = { attribute: !0, type: String, converter: je, reflect: !1, hasChanged: We };
    (Symbol.metadata ??= Symbol("metadata")), (Ve.litPropertyMetadata ??= new WeakMap());
    class Ye extends HTMLElement {
        ...
        static createProperty(e, t = Ge) {
            if (
                (t.state && (t.attribute = !1), this._$Ei(), this.elementProperties.set(e, t), !t.noAccessor)
            ) {
                const i = Symbol(),
        ...
        _$EC(e, t) {
            ...
            if (void 0 !== o && !0 === i.reflect) {
                const n = (void 0 !== i.converter?.toAttribute ? i.converter : je).toAttribute(t, i.type);
                (this._$Em = e),
                ...
                const e = i.getPropertyOptions(o),
                    n =
                        "function" == typeof e.converter
                            ...
                            ? e.converter
                            : je;
                (this._$Em = o), (this[o] = n.fromAttribute(t, e.type)), (this._$Em = null);
            }
        }
        requestUpdate(e, t, i) {
            if (void 0 !== e) {
                if (((i ??= this.constructor.getPropertyOptions(e)), !(i.hasChanged ?? We)(this[e], t)))
                    return;
                this.P(e, t, i);
            }
    ...
    const Xe = globalThis,
        Je = Xe.trustedTypes,
        Ze = Je ? Je.createPolicy("lit-html", { createHTML: (e) => e }) : void 0,
        Qe = "$lit$",
        ...
        ot = document,
        nt = () => ot.createComment(""),
        rt = (e) => null === e || ("object" != typeof e && "function" != typeof e),
        st = Array.isArray,
        at = "[ \t\n\f\r]",
    ...
    const kt = (e, t) => {
        ...
        for (let t = 0; t < i; t++) {
            ...
            let a,
                ...
                c = -1,
                d = 0;
            for (; d < i.length && ((s.lastIndex = d), (l = s.exec(i)), null !== l); )
                (d = s.lastIndex),
                    s === lt
                        ? "!--" === l[1]
                            ? (s = ct)
                            ...
                            ? (s = dt)
                            : void 0 !== l[2]
                            ? (mt.test(l[2]) && (n = RegExp("</" + l[2], "g")), (s = ht))
                            : void 0 !== l[3] && (s = ht)
                        : s === ht
                        ? ">" === l[0]
                            ? ((s = n ?? lt), (c = -1))
    ...
    class Ct {
        constructor({ strings: e, _$litType$: t }, i) {
            ...
            const s = e.length - 1,
                a = this.parts,
                [l, c] = kt(e, t);
            if (((this.el = Ct.createElement(l, i)), (yt.currentNode = this.el.content), 2 === t)) {
                ...
                if (1 === o.nodeType) {
                        ...
                        for (const e of o.getAttributeNames())
                            if (e.endsWith(Qe)) {
                                ...
                                a.push({
                                    ...
                                    o.removeAttribute(e);
                            } else e.startsWith(et) && (a.push({ type: 6, index: n }), o.removeAttribute(e));
                    if (mt.test(o.tagName)) {
                        ...
                        if (t > 0) {
                            ...
                            for (let i = 0; i < t; i++)
                                o.append(e[i], nt()), yt.nextNode(), a.push({ type: 2, index: ++n });
                            o.append(e[t], nt());
                        }
                    }
    ...
    class Rt {
        ...
        _$AI(e, t = this) {
            (e = xt(this, e, t)),
                rt(e)
                    ...
                    : void 0 !== e.nodeType
                    ? this.T(e)
                    : ((e) => st(e) || "function" == typeof e?.[Symbol.iterator])(e)
                    ? this.k(e)
                    : this._(e);
        }
        S(e) {
        ...
        $(e) {
            const { values: t, _$litType$: i } = e,
                o =
                    "number" == typeof i
                        ? this._$AC(e)
                        : (void 0 === i.el && (i.el = Ct.createElement(wt(i.h, i.h[0]), this.options)), i);
        ...
        k(e) {
            ...
            for (const n of e)
                o === t.length
                    ? t.push((i = new Rt(this.S(nt()), this.S(nt()), this, this.options)))
                    : (i = t[o]),
                    i._$AI(n),
                    o++;
    ...
    class It {
        ...
        _$AI(e, t = this, i, o) {
            ...
            let r = !1;
            if (void 0 === n)
                (e = xt(this, e, t, 0)), (r = !rt(e) || (e !== this._$AH && e !== vt)), r && (this._$AH = e);
            else {
                const o = e;
                let s, a;
            ...
            this.hasUpdated || (this.renderOptions.isConnected = this.isConnected),
                ...
                (this._$Do = ((e, t, i) => {
                    ...
                    if (void 0 === n) {
                        ...
                        o._$litPart$ = n = new Rt(t.insertBefore(nt(), e), e, void 0, i ?? {});
                    }
                    return n._$AI(e), n;
    ...
    (Mt._$litElement$ = !0), (Mt.finalized = !0), globalThis.litElementHydrateSupport?.({ LitElement: Mt });
    const Pt = globalThis.litElementPolyfillSupport;
    Pt?.({ LitElement: Mt }), (globalThis.litElementVersions ??= []).push("4.0.6");
    const Lt = (e) => (t, i) => {
            void 0 !== i
                ? i.addInitializer(() => {
        ...
        _t = { attribute: !0, type: String, converter: je, reflect: !1, hasChanged: We },
        Bt = (e = _t, t, i) => {
        ...
        return (t, i) =>
            "object" == typeof i
                ...
                : ((e, t, i) => {
                      ...
                      return (
                          t.constructor.createProperty(i, o ? { ...e, wrapped: !0 } : e),
    ...
    const Wt = "important",
        ...
        Yt = qt(
            class extends jt {
                constructor(e) {
                    if ((super(e), e.type !== Vt || "style" !== e.name || e.strings?.length > 2))
                        throw Error(
                ...
                update(e, [t]) {
                    ...
                    for (const e of this.ft)
                        null == t[e] &&
                            (this.ft.delete(e), e.includes("-") ? i.removeProperty(e) : (i[e] = null));
                    for (const e in t) {
                        const o = t[e];
                        if (null != o) {
                            this.ft.add(e);
                            ...
                            e.includes("-") || t
                                ? i.setProperty(e, t ? o.slice(0, -11) : o, t ? Wt : "")
                                : (i[e] = o);
                        }
                    }
                    return vt;
    ...
    class Xt extends Mt {
        emit(e, t) {
            const i = new CustomEvent(
                e,
                Object.assign({ bubbles: !0, cancelable: !1, composed: !0, detail: {} }, t)
            );
    ...
    let ei = class extends jt {
        ...
        render(e) {
            ...
            const t = [e];
            return (
                (t.raw = t), (this._t = { _$litType$: this.constructor.resultType, strings: t, values: [] })
            );
        }
    };
    ...
    function li(e) {
        void 0 !== this._$AN ? (si(this), (this._$AM = e), ai(this)) : (this._$AM = e);
    }
    function ci(e, t = !1, i = 0) {
        ...
        if (void 0 !== n && 0 !== n.size)
            if (t)
                if (Array.isArray(o)) for (let e = i; e < o.length; e++) ri(o[e], !1), si(o[e]);
    ...
    (e.Icon = class extends Xt {
        constructor() {
            super(...arguments), (this.hasSlotController = new Jt(this, "[default]"));
        }
        render() {
            return this.hasSlotController.test("[default]")
                ...
                : (() => {
                      if (this.name) {
                          ...
                          return ft`<span style="${Yt({ fontFamily: i.get(t) })}">${e}</span>`;
                      }
                      return this.src ? ft`${vi(Ie({ url: this.src }).then(ii))}` : ft``;
                  })();
        }
    }),
        (e.Icon.styles = [Qt, gi]),
    ...
    (e.Avatar = class extends Xt {
        ...
        render() {
            return this.hasSlotController.test("[default]")
                ? ft`<slot></slot>`
                : this.src
                ? ft`<img part="image" alt="${Ft(this.label)}" src="${this.src}" style="${Yt({
                      objectFit: this.fit,
                  })}">`
                : this.icon
    ...
    class ki {
        ...
        isDefined() {
            return (
                !!this.defined ||
                ((this.defined = (!this.needDomReady || S()) && !this.getUndefinedLocalNames().length),
                this.defined)
            );
        }
        async whenDefined() {
            ...
            this.needDomReady &&
                !S(e) &&
                (await new Promise((t) => {
                    e.addEventListener("DOMContentLoaded", () => t(), { once: !0 });
                }));
    ...
    const xi = new WeakMap(),
        $i = (e) => {
            class t extends e {
                constructor(...e) {
                    super(...e),
                        (this.scrollBehaviorDefinedController = new ki(this, { needDomReady: !0 })),
                ...
                async onScrollTargetChange(e, t) {
                    ...
                    if (
                        ...
                        i && (this.setContainerPadding("remove", e), this.setContainerPadding("add", t)),
                        !this.scrollBehavior)
                    )
                        return;
                    const o = this.getListening(e);
                    o && o.removeEventListener("scroll", this.onListeningScroll);
                    const n = this.getListening(t);
                    n && (this.updateScrollTop(n), n.addEventListener("scroll", this.onListeningScroll));
                }
                async onScrollBehaviorChange() {
                    ...
                    e &&
                        (this.scrollBehavior
                            ? (this.updateScrollTop(e), e.addEventListener("scroll", this.onListeningScroll))
                            : e.removeEventListener("scroll", this.onListeningScroll));
                }
                connectedCallback() {
                ...
                setContainerPadding(e, t) {
                    ...
                    if ("add" === e || "update" === e) {
                        const t = ["fixed", "absolute"].includes(M(this).css("position"))
                            ? this.offsetHeight
                            : null;
                    ...
                    if ("remove" === e) {
                        ...
                        t > -1 && (e[o].splice(t, 1), xi.set(i, e)), e[o].length || M(i).css({ [n]: null });
                    }
                }
                onListeningScroll() {
                    const e = this.getListening(this.scrollTarget);
                ...
                onScroll(e) {
                    ...
                    this.lastScrollTopNoThreshold !== t &&
                        (this.runScrollNoThreshold(t < this.lastScrollTopNoThreshold, t),
                        (this.lastScrollTopNoThreshold = t)),
                        Math.abs(t - this.lastScrollTopThreshold) > (this.scrollThreshold || 0) &&
                            (this.runScrollThreshold(t < this.lastScrollTopThreshold, t),
            ...
            return (
                Se([Ot({ attribute: "scroll-target" })], t.prototype, "scrollTarget", void 0),
                Se(
                ...
                Se(
                    [Ot({ type: Number, reflect: !0, attribute: "scroll-threshold" })],
                    t.prototype,
                    "scrollThreshold",
                    void 0
                ),
                ...
                unobserve: () => {
                    i.each((e, t) => {
                        ...
                        -1 !== n && i.coArr.splice(n, 1),
                            i.coArr.length ? Si.set(t, i) : (Ei.unobserve(t), Si.delete(t));
                    });
                },
            };
        return (
    ...
    class Di {
        ...
        registerItem(e) {
            ...
            this.states.push(t),
                (t.observeResize = Ti(t.element, () => {
                    this.updateLayout(t.element, { width: this.isNoWidth(t) ? 0 : void 0 });
                })),
                (this.items = void 0),
                this.resort(),
                this.updateLayout();
        ...
        updateLayout(e, t) {
            const i = e ? { element: e, width: t?.width, height: t?.height } : void 0,
            ...
            Object.assign(this.states[o], i),
                this.states.forEach((e, t) => {
                    ...
                    const i = e.element.layoutPlacement,
                        ...
                        a = n?.bottom ?? 0,
                        l = n?.left ?? 0;
                    switch ((Object.assign(e, { top: r, right: s, bottom: a, left: l }), i)) {
                        case "top":
                        case "bottom":
    ...
    class Pi extends Xt {
        ...
        connectedCallback() {
            ...
            (this.isParentLayout = a(e, "mdui-layout")),
                this.isParentLayout && ((this.layoutManager = Mi(e)), this.layoutManager.registerItem(this));
        }
        disconnectedCallback() {
            super.disconnectedCallback(), this.layoutManager && this.layoutManager.unregisterItem(this);
        }
    }
    ...
    (e.BottomAppBar = class extends $i(Pi) {
        ...
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.BottomAppBar.prototype, "hide", void 0),
        Se(
            [Ot({ type: Boolean, reflect: !0, converter: wi, attribute: "fab-detach" })],
            ...
            class extends hi {
                ...
                update(e, [t]) {
                    ...
                    return (
                        ...
                        (i || this.lt !== this.ct) &&
                            ((this.Y = t), (this.ht = e.options?.host), this.rt((this.ct = e.element))),
                        gt
                    );
                }
                rt(e) {
    ...
    function Ni(e) {
        ...
        let t = "";
        if (Array.isArray(e))
            for (let i, o = 0; o < e.length; o++) "" !== (i = Ni(e[o])) && (t += (t && " ") + i);
    ...
    class Hi {
        ...
        hostConnected() {
            this.definedController.whenDefined().then(() => {
                (this.form = this.options.form(this.host)), this.form && this.attachForm(this.form);
            });
        }
        hostDisconnected() {
            this.detachForm();
        ...
        detachForm() {
            this.form &&
                ...
                Fi.has(this.form) &&
                    ...
                    ((this.form.reportValidity = Fi.get(this.form)), Fi.delete(this.form)));
        }
        doAction(e, t) {
            if (!this.form) return;
        ...
        reportFormValidity() {
            if (this.form && !this.form.noValidate) {
                ...
                for (const t of e) if (l(t.reportValidity) && !t.reportValidity()) return !1;
            }
            return !0;
        }
    }
    const Ui = (e) => {
        class t extends e {
            renderAnchor({
                ...
                return ft`<a ${n} id="${Ft(e)}" class="_a ${t || ""}" part="${Ft(i)}" href="${Ft(
                    this.href
                )}" download="${Ft(this.download)}" target="${Ft(this.target)}" rel="${Ft(
                    this.rel
                )}" tabindex="${Ft(r)}">${o}</a>`;
            }
        }
    ...
    const ji = (e) => {
            class t extends e {
                constructor() {
                    super(...arguments),
                        ...
                        (this.focused = !1),
                        (this.focusVisible = !1),
                        (this.focusableDefinedController = new ki(this, { relatedElements: [""] })),
                        (this._manipulatingTabindex = !1),
                        (this._tabIndex = 0);
                }
                get tabIndex() {
                    const e = M(this);
                    if (this.focusElement === this) return Number(e.attr("tabindex") || -1);
                ...
                set tabIndex(e) {
                    if (this._manipulatingTabindex) return void (this._manipulatingTabindex = !1);
                    const t = M(this);
                    ...
                    const i = () => {
                        -1 === this.tabIndex && ((this.tabIndex = 0), this.focus({ preventScroll: !0 }));
                    };
                    if (
                        (-1 === e
                            ? this.addEventListener("pointerdown", i)
                            : ((this._manipulatingTabindex = !0), this.removeEventListener("pointerdown", i)),
                        -1 === e || this.focusDisabled)
                    )
                        return t.attr("tabindex", -1), void (-1 !== e && this.manageFocusElementTabindex(e));
                ...
                update(e) {
                    if (
                        ...
                        this.focusDisabled
                            ...
                            : this.focusElement === this
                            ? ((this._manipulatingTabindex = !0), e.attr("tabindex", this._tabIndex))
                            : this.tabIndex > -1 && e.removeAttr("tabindex");
                    }
                    super.update(e);
                }
                updated(e) {
                    super.updated(e), this.focused && this.focusDisabled && this.blur();
                }
            ...
            return (
                Se([Ot({ type: Boolean, reflect: !0, converter: wi })], t.prototype, "autofocus", void 0),
                Se([Ot({ type: Boolean, reflect: !0, converter: wi })], t.prototype, "focused", void 0),
                Se(
                    [Ot({ type: Boolean, reflect: !0, converter: wi, attribute: "focus-visible" })],
                    t.prototype,
                    "focusVisible",
                    void 0
                ),
                Se([Ot({ type: Number, attribute: "tabindex" })], t.prototype, "tabIndex", null),
                t
            );
        },
        Wi = qt(
            class extends jt {
                constructor(e) {
                    if ((super(e), e.type !== Vt || "class" !== e.name || e.strings?.length > 2))
                        throw Error(
                ...
                update(e, [t]) {
                    ...
                    for (const e of this.st) e in t || (i.remove(e), this.st.delete(e));
                    for (const e in t) {
                        const o = !!t[e];
                        o === this.st.has(e) ||
                            this.nt?.has(e) ||
    ...
    (e.CircularProgress = class extends Xt {
        ...
        render() {
            ...
            return ft`<div class="progress ${Wi({ determinate: e, indeterminate: !e })}">${
        ...
        renderInDeterminate() {
            ...
            return ft`<div class="layer"><div class="clipper left">${t(4)}</div><div class="gap-patch">${t(
                3.2
            )}</div><div class="clipper right">${t(4)}</div></div>`;
        }
    }),
        (e.CircularProgress.styles = [Qt, Gi]),
        Se([Ot({ type: Number, reflect: !0 })], e.CircularProgress.prototype, "max", void 0),
        Se([Ot({ type: Number })], e.CircularProgress.prototype, "value", void 0),
    ...
    (e.Ripple = class extends Xt {
        ...
        startPress(e) {
            ...
            if (e) {
                const s =
                        "undefined" != typeof TouchEvent && e instanceof TouchEvent && e.touches.length
                            ? e.touches[0]
                            : e,
                    a = t.offset();
            ...
            const s = Math.max(Math.pow(Math.pow(i, 2) + Math.pow(o, 2), 0.5), 48),
                a = o / 2 - n + "px",
                l = i / 2 - r + "px",
                c = `translate3d(${a}, ${l}, 0) scale(1)`;
            M('<div class="wave"></div>')
                .css({ width: s, height: s, marginTop: -s / 2, marginLeft: -s / 2, left: n, top: r })
                .each((e, t) => {
        ...
        Se(
            [Ot({ type: Boolean, reflect: !0, converter: wi, attribute: "no-ripple" })],
            e.Ripple.prototype,
            "noRipple",
            void 0
        ),
    ...
    const Xi = (e) => {
            class t extends e {
                ...
                endHover(e) {
                    "mouse" !== e.pointerType ||
                        this.isRippleDisabled() ||
                        (this.getRippleTarget().removeAttribute("hover"), this.getRippleElement().endHover());
                }
                isRippleDisabled() {
                ...
                startPress(e) {
                    ...
                    if ((t.setAttribute("pressed", ""), ["touch", "pen"].includes(e.pointerType))) {
                        let i = !1,
                            o = setTimeout(() => {
                                (o = 0), this.getRippleElement().startPress(e);
                            }, 70);
                        const n = () => {
                                o && (clearTimeout(o), (o = 0), this.getRippleElement().startPress(e)),
                                    i || ((i = !0), this.endPress()),
                                    t.removeEventListener("pointerup", n),
                                    t.removeEventListener("pointercancel", n);
                            },
                            r = () => {
                                o && (clearTimeout(o), (o = 0)), t.removeEventListener("touchmove", r);
                            };
    ...
    class Zi extends Ui(Xi(ji(Xt))) {
        ...
        checkValidity() {
            if (this.isButton()) {
                ...
                return e || this.emit("invalid", { bubbles: !1, cancelable: !0, composed: !1 }), e;
            }
            return !0;
        }
        reportValidity() {
    ...
    (Zi.styles = [Qt, Ji]),
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], Zi.prototype, "disabled", void 0),
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], Zi.prototype, "loading", void 0),
        ...
        Se([Ot({ reflect: !0, attribute: "formaction" })], Zi.prototype, "formAction", void 0),
        Se([Ot({ reflect: !0, attribute: "formenctype" })], Zi.prototype, "formEnctype", void 0),
        Se([Ot({ reflect: !0, attribute: "formmethod" })], Zi.prototype, "formMethod", void 0),
        Se(
            [Ot({ type: Boolean, reflect: !0, converter: wi, attribute: "formnovalidate" })],
            Zi.prototype,
            "formNoValidate",
            void 0
        ),
        Se([Ot({ reflect: !0, attribute: "formtarget" })], Zi.prototype, "formTarget", void 0);
    ...
    (e.Button = class extends Zi {
        constructor() {
            super(...arguments), (this.variant = "filled"), (this.fullWidth = !1), (this.rippleRef = _i());
        }
        get rippleElement() {
            return this.rippleRef.value;
        }
        render() {
            return ft`<mdui-ripple ${zi(this.rippleRef)} .noRipple="${this.noRipple}"></mdui-ripple>${
                this.isButton()
                    ? this.renderButton({ className: "button", part: "button", content: this.renderInner() })
                    : this.disabled || this.loading
                    ? ft`<span part="button" class="button _a">${this.renderInner()}</span>`
                    : this.renderAnchor({ className: "button", part: "button", content: this.renderInner() })
            }`;
        }
        renderIcon() {
            return this.loading
        ...
        renderEndIcon() {
            return ft`<slot name="end-icon" part="end-icon" class="end-icon">${
                this.endIcon ? ft`<mdui-icon name="${this.endIcon}"></mdui-icon>` : Zt
            }</slot>`;
        }
        renderInner() {
        ...
        Se(
            [Ot({ type: Boolean, reflect: !0, converter: wi, attribute: "full-width" })],
            e.Button.prototype,
            "fullWidth",
            void 0
        ),
        Se([Ot({ reflect: !0 })], e.Button.prototype, "icon", void 0),
        Se([Ot({ reflect: !0, attribute: "end-icon" })], e.Button.prototype, "endIcon", void 0),
    ...
    (e.ButtonIcon = class extends Zi {
        ...
        render() {
            return ft`<mdui-ripple ${zi(this.rippleRef)} .noRipple="${this.noRipple}"></mdui-ripple>${
                this.isButton()
                    ? this.renderButton({ className: "button", part: "button", content: this.renderIcon() })
                    : this.disabled || this.loading
        ...
        Se([Ot({ reflect: !0, attribute: "selected-icon" })], e.ButtonIcon.prototype, "selectedIcon", void 0),
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.ButtonIcon.prototype, "selectable", void 0),
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.ButtonIcon.prototype, "selected", void 0),
    ...
    (e.Card = class extends Ui(Xi(ji(Xt))) {
        ...
        render() {
            return ft`<mdui-ripple ${zi(this.rippleRef)} .noRipple="${this.noRipple}"></mdui-ripple>${
                this.href && !this.disabled
                    ? this.renderAnchor({ className: "link", content: ft`<slot></slot>` })
                    : ft`<slot></slot>`
            }`;
        }
    }),
        ...
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.Card.prototype, "clickable", void 0),
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.Card.prototype, "disabled", void 0),
    ...
    const io = qt(
        class extends jt {
            constructor(e) {
                ...
                if (!oi(e)) throw Error("`live` bindings can only contain a single expression");
            }
            render(e) {
                return e;
            }
            update(e, [t]) {
                ...
                } else if (e.type === Vt && i.getAttribute(o) === t + "") return vt;
                return (
                    ((e, t = ni) => {
                        e._$AH = t;
                    })(e),
    ...
    (e.Checkbox = class extends Xi(ji(Xt)) {
        ...
        async onDisabledChange() {
            await this.updateComplete, (this.invalid = !this.inputRef.value.checkValidity());
        }
        ...
        reportValidity() {
            if (((this.invalid = !this.inputRef.value.reportValidity()), this.invalid)) {
                this.emit("invalid", { bubbles: !1, cancelable: !0, composed: !1 }) ||
                    (this.blur(), this.focus());
            }
            return !this.invalid;
        }
        setCustomValidity(e) {
            this.inputRef.value.setCustomValidity(e), (this.invalid = !this.inputRef.value.checkValidity());
        }
        render() {
            return ft`<label class="${Wi({ invalid: this.invalid })}"><input ${zi(
                this.inputRef
            )} type="checkbox" name="${Ft(this.name)}" value="${Ft(this.value)}" .indeterminate="${io(
                this.indeterminate
            )}" .disabled="${this.disabled}" .checked="${io(this.checked)}" .required="${
                this.required
            }" @change="${this.onChange}"> <i part="control"><mdui-ripple ${zi(this.rippleRef)} .noRipple="${
                this.noRipple
        ...
        onChange() {
            (this.checked = this.inputRef.value.checked), (this.indeterminate = !1), this.emit("change");
        }
    }),
        (e.Checkbox.styles = [Qt, co]),
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.Checkbox.prototype, "disabled", void 0),
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.Checkbox.prototype, "checked", void 0),
        ...
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.Checkbox.prototype, "required", void 0),
        ...
        Se([Ot({ reflect: !0, attribute: "unchecked-icon" })], e.Checkbox.prototype, "uncheckedIcon", void 0),
        Se([Ot({ reflect: !0, attribute: "checked-icon" })], e.Checkbox.prototype, "checkedIcon", void 0),
        Se(
    ...
    (e.Chip = class extends Zi {
        ...
        render() {
            ...
            return ft`<mdui-ripple ${zi(this.rippleRef)} .noRipple="${this.noRipple}"></mdui-ripple>${
                this.isButton()
                    ? this.renderButton({ className: o, part: "button", content: this.renderInner() })
                    : this.disabled || this.loading
                    ? ft`<span part="button" class="${o} _a">${this.renderInner()}</span>`
                    : this.renderAnchor({ className: o, part: "button", content: this.renderInner() })
            }`;
        }
        onClick() {
        ...
        onKeyDown(e) {
            this.disabled ||
                this.loading ||
                (this.selectable && " " === e.key && (e.preventDefault(), (this.selected = !this.selected)),
            ...
            return this.selected
                ? ft`<slot name="selected-icon" part="selected-icon" class="selected-icon">${(() =>
                      this.selectedIcon
                          ...
                          : "assist" === this.variant || "filter" === this.variant
        ...
        renderEndIcon() {
            return ft`<slot name="end-icon" part="end-icon" class="end-icon">${
                this.endIcon ? ft`<mdui-icon name="${this.endIcon}" class="i"></mdui-icon>` : Zt
            }</slot>`;
        }
        renderDeleteIcon() {
        ...
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.Chip.prototype, "elevated", void 0),
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.Chip.prototype, "selectable", void 0),
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.Chip.prototype, "selected", void 0),
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.Chip.prototype, "deletable", void 0),
        Se([Ot({ reflect: !0 })], e.Chip.prototype, "icon", void 0),
        Se([Ot({ reflect: !0, attribute: "selected-icon" })], e.Chip.prototype, "selectedIcon", void 0),
        Se([Ot({ reflect: !0, attribute: "end-icon" })], e.Chip.prototype, "endIcon", void 0),
        Se([Ot({ reflect: !0, attribute: "delete-icon" })], e.Chip.prototype, "deleteIcon", void 0),
    ...
    (e.Collapse = class extends Xt {
        constructor() {
            super(...arguments),
                ...
                (this.activeKeys = []),
                (this.isInitial = !0),
                (this.definedController = new ki(this, { relatedElements: ["mdui-collapse-item"] }));
        }
        async onActiveKeysChange() {
            await this.definedController.whenDefined();
            const e = this.accordion
                ? this.items.find((e) => this.activeKeys.includes(e.key))?.value
                : this.items.filter((e) => this.activeKeys.includes(e.key)).map((e) => e.value);
        ...
        onClick(e) {
            ...
            if (
                ...
                if (this.accordion)
                    ...
                    e.includes(t.key) ? e.splice(e.indexOf(t.key), 1) : e.push(t.key), this.setActiveKeys(e);
                }
        ...
        updateItems() {
            this.items.forEach((e) => {
                (e.active = this.activeKeys.includes(e.key)), (e.isInitial = this.isInitial);
            });
        }
    }),
        (e.Collapse.styles = [Qt, fo]),
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.Collapse.prototype, "accordion", void 0),
        Se([Ot()], e.Collapse.prototype, "value", void 0),
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.Collapse.prototype, "disabled", void 0),
        Se([zt()], e.Collapse.prototype, "activeKeys", void 0),
        Se([Nt({ selector: "mdui-collapse-item", flatten: !0 })], e.Collapse.prototype, "items", void 0),
    ...
    function bo(e, t, i) {
        return e
            ? new Promise((o) => {
                  if (i.duration === 1 / 0) throw new Error("Promise-based animations must be finite.");
                  ...
                  e.getAnimations().map(
                      (e) =>
                          new Promise((t) => {
                              ...
                              e.addEventListener("cancel", () => i, { once: !0 }),
                                  e.addEventListener("finish", () => i, { once: !0 }),
                                  e.cancel();
                          })
                  )
              )
    ...
    function wo(e) {
        ...
        return (
            ...
            (!e.hasAttribute("aria-disabled") || "false" === e.getAttribute("aria-disabled")) &&
            !("input" === i && "radio" === e.getAttribute("type") && !e.hasAttribute("checked")) &&
            null !== e.offsetParent &&
            "hidden" !== t.getComputedStyle(e).visibility &&
            (!(("audio" !== i && "video" !== i) || !e.hasAttribute("controls")) ||
                !!e.hasAttribute("tabindex") ||
                !(!e.hasAttribute("contenteditable") || "false" === e.getAttribute("contenteditable")) ||
                ["button", "input", "select", "textarea", "a", "audio", "video", "summary"].includes(i))
        );
    }
    (e.CollapseItem = class extends Xt {
        ...
        render() {
            return ft`<slot name="header" part="header" class="header">${
                ...
                active: this.active,
            })}" ${zi(this.bodyRef)} @transitionend="${this.onTransitionEnd}"></slot>`;
        }
        onTransitionEnd(e) {
        ...
        updateBodyHeight() {
            ...
            "close" === this.state && (M(this.bodyRef.value).height(e), this.bodyRef.value.clientLeft),
                M(this.bodyRef.value).height(
                    "opened" === this.state ? "auto" : "open" === this.state ? e : 0
                );
        }
    }),
        ...
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.CollapseItem.prototype, "disabled", void 0),
    ...
    const Io = (e) => {
        ...
        To = (e, t) => {
            ...
            So.get(t).add(e);
            const o = M(t);
            ((e) => e.scrollHeight > e.clientHeight)(t) && o.css("width", `calc(100% - ${Io()}px)`),
                o.addClass(Eo);
        },
        Do = (e, t) => {
            const i = n();
            t ??= i.documentElement;
            const o = So.get(t);
            o && (o.delete(e), 0 === o.size && (So.delete(t), M(t).removeClass(Eo).width("")));
        },
        Ao = (e, t, i) => {
            let o = e[0];
            for (let n = 1; n < e.length; n++) (o += t[i ? i[n - 1] : n - 1]), (o += e[n]);
            return o;
        },
        Mo = (e) => {
    ...
    const _o = [];
    for (let e = 0; e < 256; e++) _o[e] = ((e >> 4) & 15).toString(16) + (15 & e).toString(16);
    const Bo = "",
        Oo = "h",
        zo = "s";
    function No(e, t) {
        ...
        if (e) {
            const o =
                    ...
                    (function (e) {
                        ...
                        let i = Vo.get(t);
                        void 0 === i && ((i = No(t, "string" != typeof e && !("strTag" in e))), Vo.set(t, i));
                        return i;
                    })(t),
                n = e[o];
            if (n) {
    ...
    const Zo = (e) => (
            (function (e) {
                if (on) throw new Error("lit-localize can only be configured once");
                (tn = e), (on = !0);
            })((e, t) => Ho(Go, e, t)),
        ...
        en = (e) => {
            ...
            Jo++;
            const t = Jo;
            (Ko = e), Xo.settled && (Xo = new Lo()), Uo({ status: "loading", loadingLocale: e });
            return (
                (e === qo ? Promise.resolve({ templates: void 0 }) : Wo(e)).then(
                    (i) => {
                        Jo === t &&
                            ((Yo = e),
                            (Ko = void 0),
                    ...
                    (i) => {
                        Jo === t &&
                            (Uo({ status: "error", errorLocale: e, errorMessage: i.toString() }),
                            Xo.reject(i));
                    }
                ),
                Xo.promise
    ...
    const nn = [
        ...
        rn = "You must call `loadLocale` first to set up the localized template.";
    let sn, an;
    let ln = !1;
    const cn = new Map(),
        dn = (e, t) => {
    ...
    (e.Dialog = class extends Xt {
        constructor() {
            super(...arguments),
                ...
                (this.definedController = new ki(this, { relatedElements: ["mdui-top-app-bar"] }));
        }
        async onOpenChange() {
            const e = this.hasUpdated;
            if (!this.open && !e) return;
            await this.definedController.whenDefined(), e || (await this.updateComplete);
            const t = Array.from(this.panelRef.value.querySelectorAll(".header, .body, .actions")),
                ...
                r = () =>
                    Promise.all([yo(this.overlayRef.value), yo(this.panelRef.value), ...t.map((e) => yo(e))]);
            if (this.open) {
                if (e) {
                ...
                (this.originalTrigger = document.activeElement),
                    ...
                    requestAnimationFrame(() => {
                        ...
                        e ? e.focus({ preventScroll: !0 }) : this.panelRef.value.focus({ preventScroll: !0 });
                    });
                const s = $o(this, "medium4");
                await Promise.all([
                    bo(this.overlayRef.value, [{ opacity: 0 }, { opacity: 1, offset: 0.3 }, { opacity: 1 }], {
                        duration: e ? s : 0,
                        easing: i,
                    }),
                    bo(
                    ...
                    bo(this.panelRef.value, [{ opacity: 0 }, { opacity: 1, offset: 0.1 }, { opacity: 1 }], {
                        duration: e ? s : 0,
                        easing: i,
                    }),
                    ...t.map((t) =>
                ...
                await Promise.all([
                    bo(this.overlayRef.value, [{ opacity: 1 }, { opacity: 0 }], { duration: e, easing: i }),
                    bo(
                        this.panelRef.value,
                        [
                            { transform: "translateY(0) scaleY(1)" },
                    ...
                    bo(this.panelRef.value, [{ opacity: 1 }, { opacity: 1, offset: 0.75 }, { opacity: 0 }], {
                        duration: e,
                        easing: i,
                    }),
                    ...t.map((t) =>
                        bo(t, [{ opacity: 1 }, { opacity: 0, offset: 0.75 }, { opacity: 0 }], {
                            duration: e,
                            easing: i,
                        })
                    ),
                ...
                "function" == typeof o?.focus && setTimeout(() => o.focus()), this.emit("closed");
            }
        }
        disconnectedCallback() {
        ...
        render() {
            const e = this.hasSlotController.test("action"),
                ...
                n = !!this.description || this.hasSlotController.test("description"),
                r = i || o || this.hasSlotController.test("header"),
                s = n || t;
            return ft`<div ${zi(this.overlayRef)} part="overlay" class="overlay" @click="${
                this.onOverlayClick
            }" tabindex="-1"></div><div ${zi(this.panelRef)} part="panel" class="panel ${Wi({
                "has-icon": i,
                "has-description": n,
                "has-default": t,
            })}" tabindex="0">${go(
                r,
                () =>
                    ft`<slot name="header" part="header" class="header">${go(i, () =>
                        this.renderIcon()
                    )} ${go(o, () => this.renderHeadline())}</slot>`
            )} ${go(
                s,
                () =>
                    ft`<div ${zi(this.bodyRef)} part="body" class="body">${go(n, () =>
                        this.renderDescription()
                    )}<slot></slot></div>`
            )} ${go(e, () => ft`<slot name="action" part="action" class="action"></slot>`)}</div>`;
        }
        onOverlayClick() {
            this.emit("overlay-click"), this.closeOnOverlayClick && (this.open = !1);
        }
        renderIcon() {
        ...
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.Dialog.prototype, "open", void 0),
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.Dialog.prototype, "fullscreen", void 0),
        Se(
            [Ot({ type: Boolean, reflect: !0, converter: wi, attribute: "close-on-esc" })],
            e.Dialog.prototype,
            "closeOnEsc",
            void 0
        ),
        Se(
            [Ot({ type: Boolean, reflect: !0, converter: wi, attribute: "close-on-overlay-click" })],
            e.Dialog.prototype,
            "closeOnOverlayClick",
            void 0
        ),
        Se(
            [Ot({ type: Boolean, reflect: !0, converter: wi, attribute: "stacked-actions" })],
            e.Dialog.prototype,
            "stackedActions",
            void 0
        ),
    ...
    function gn(e) {
        return "undefined" != typeof ShadowRoot && (e instanceof ShadowRoot || e instanceof fn(e).ShadowRoot);
    }
    function bn(e) {
        const {
            overflow: t,
        ...
        return /auto|scroll|overlay|hidden|clip/.test(t + o + i) && !["inline", "contents"].includes(n);
    }
    function yn(e) {
        ...
        const t =
            ...
            (function (e) {
                var t;
                return null == (t = (vn(e) ? e.ownerDocument : e.document) || window.document)
                    ? void 0
                    : t.documentElement;
            })(e);
    ...
    function wn(e) {
        ...
        return (function (e) {
            ...
            ? e.ownerDocument
                ...
                : e.body
            : ((i = t) instanceof HTMLElement || i instanceof fn(i).HTMLElement) && bn(t)
            ? t
            : wn(t);
        var i;
    }
    ...
    (e.Divider = class extends Xt {
        constructor() {
            super(...arguments), (this.vertical = !1), (this.inset = !1), (this.middle = !1);
        }
        render() {
            return ft``;
        }
        ...
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.Divider.prototype, "vertical", void 0),
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.Divider.prototype, "inset", void 0),
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.Divider.prototype, "middle", void 0),
    ...
    (e.Dropdown = class extends Xt {
        constructor() {
            super(),
                ...
                (this.panelRef = _i()),
                (this.definedController = new ki(this, { relatedElements: [""] })),
        ...
        async onPositionChange() {
            this.open && (await this.definedController.whenDefined(), this.updatePositioner());
        }
        async onOpenChange() {
            const e = this.hasUpdated;
            if (!this.open && !e) return;
        ...
        disconnectedCallback() {
            !this.open && this.panelRef.value && (this.panelRef.value.hidden = !0),
                super.disconnectedCallback(),
        ...
        render() {
            return ft`<slot name="trigger" part="trigger" class="trigger"></slot><slot ${zi(
                this.panelRef
            )} part="panel" class="panel" hidden @click="${this.onPanelClick}"></slot>`;
        }
        getCssScaleName() {
        ...
        onDocumentKeydown(e) {
            !this.disabled &&
                ...
                ("Escape" !== e.key
                    ? "Tab" === e.key &&
                      (!this.hasTrigger("focus") && l(this.triggerElement?.focus) && e.preventDefault(),
                      (this.open = !1))
                    : (this.open = !1));
        }
        onWindowScroll() {
        ...
        onClick(e) {
            this.disabled ||
                e.button ||
                !this.hasTrigger("click") ||
                (this.open && (this.hasTrigger("hover") || this.hasTrigger("focus"))) ||
        ...
        updatePositioner() {
            ...
            if ("auto" === h) {
                ...
                (r =
                    ...
                    (a = ["top", "bottom"].includes(r)
                        ? e - s.left > o + 8
                            ? "start"
                            : s.left + s.width / 2 > o / 2 + 8 && e - s.left - s.width / 2 > o / 2 + 8
                            ? void 0
                            : s.left + s.width > o + 8
                            ? "end"
                            : "start"
                        : i - s.top > n + 8
                        ? "start"
                        : s.top + s.height / 2 > n / 2 + 8 && i - s.top - s.height / 2 > n / 2 + 8
                        ? void 0
                        : s.top + s.height > n + 8
                        ? "end"
                        : "start"),
            ...
            const [u, p] = h.split("-");
            switch (
                ((this.animateDirection = ["top", "bottom"].includes(u) ? "vertical" : "horizontal"), u)
            ) {
                case "top":
                    (l = "bottom"), (c = s.top - n);
                    break;
        ...
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.Dropdown.prototype, "open", void 0),
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.Dropdown.prototype, "disabled", void 0),
        Se([Ot({ reflect: !0 })], e.Dropdown.prototype, "trigger", void 0),
        Se([Ot({ reflect: !0 })], e.Dropdown.prototype, "placement", void 0),
        Se(
            [Ot({ type: Boolean, reflect: !0, converter: wi, attribute: "stay-open-on-click" })],
        ...
        Se(
            [Ot({ type: Boolean, reflect: !0, converter: wi, attribute: "open-on-pointer" })],
            e.Dropdown.prototype,
            "openOnPointer",
            void 0
        ),
        Se([Nt({ slot: "trigger", flatten: !0 })], e.Dropdown.prototype, "triggerElements", void 0),
        Se([Nt({ flatten: !0 })], e.Dropdown.prototype, "panelElements", void 0),
    ...
    (e.Fab = class extends Zi {
        ...
        async onExtendedChange() {
            ...
            this.extended ? (this.style.width = `${this.scrollWidth}px`) : (this.style.width = ""),
                ...
                e || (await xn(), (this.style.transitionProperty = "box-shadow, width, bottom, transform"));
        }
        render() {
            const e = Ni({ button: !0, "has-icon": this.icon || this.hasSlotController.test("icon") });
            return ft`<mdui-ripple ${zi(this.rippleRef)} .noRipple="${this.noRipple}"></mdui-ripple>${
                this.isButton()
                    ? this.renderButton({ className: e, part: "button", content: this.renderInner() })
                    : this.disabled || this.loading
                    ? ft`<span part="button" class="_a ${e}">${this.renderInner()}</span>`
                    : this.renderAnchor({ className: e, part: "button", content: this.renderInner() })
            }`;
        }
        renderLabel() {
            return ft`<slot part="label" class="label"></slot>`;
        ...
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.Fab.prototype, "extended", void 0),
    ...
    (e.Layout = class extends Xt {
        ...
        Se(
            [Ot({ type: Boolean, reflect: !0, converter: wi, attribute: "full-height" })],
            e.Layout.prototype,
            "fullHeight",
            void 0
        ),
    ...
    (e.LayoutMain = class extends Xt {
        connectedCallback() {
            super.connectedCallback();
            const e = this.parentElement;
            a(e, "mdui-layout") && ((this.layoutManager = Mi(e)), this.layoutManager.registerMain(this));
        }
        disconnectedCallback() {
            super.disconnectedCallback(), this.layoutManager && this.layoutManager.unregisterMain();
        }
        render() {
            return ft`<slot></slot>`;
        }
    ...
    (e.LinearProgress = class extends Xt {
        ...
        Se([Ot({ type: Number, reflect: !0 })], e.LinearProgress.prototype, "max", void 0),
    ...
    (e.ListItem = class extends Ui(Xi(ji(Xt))) {
        ...
        render() {
            const e = Ni({
                ...
                "is-end-icon": ((t = this.endIconElements[0]), t?.nodeName.toLowerCase() ?? "").startsWith(
                    "mdui-icon-"
                ),
            });
            var t;
            return ft`<mdui-ripple ${zi(this.rippleRef)} .noRipple="${this.noRipple}"></mdui-ripple>${
                this.href && !this.disabled
                    ...
                    : ft`<div part="container" class="${e}" ${zi(this.itemRef)}>${this.renderInner()}</div>`
            }`;
        }
        renderInner() {
        ...
        Se([Ot({ reflect: !0, attribute: "end-icon" })], e.ListItem.prototype, "endIcon", void 0),
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.ListItem.prototype, "disabled", void 0),
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.ListItem.prototype, "active", void 0),
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.ListItem.prototype, "nonclickable", void 0),
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.ListItem.prototype, "rounded", void 0),
        Se([Ot({ reflect: !0 })], e.ListItem.prototype, "alignment", void 0),
        Se([Nt({ slot: "icon", flatten: !0 })], e.ListItem.prototype, "iconElements", void 0),
        Se([Nt({ slot: "end-icon", flatten: !0 })], e.ListItem.prototype, "endIconElements", void 0),
    ...
    (e.MenuItem = class extends Ui(Xi(ji(Xt))) {
        ...
        disconnectedCallback() {
            super.disconnectedCallback(), document.removeEventListener("pointerdown", this.onOuterClick);
        }
        firstUpdated(e) {
            super.firstUpdated(e),
                this.definedController.whenDefined().then(() => {
        ...
        render() {
            ...
            return ft`<mdui-ripple ${zi(this.rippleRef)} .noRipple="${this.noRipple}"></mdui-ripple>${
                this.href && !this.disabled
                    ...
                    : ft`<div part="container" ${zi(this.containerRef)} class="${a}">${this.renderInner(
                          o,
                          r
                      )}</div>`
            } ${go(
        ...
        onClick(e) {
            this.disabled ||
                ...
                (this.hasTrigger("click") &&
                    e.target === this &&
                    this.hasSubmenu &&
                    ((this.submenuOpen && (this.hasTrigger("hover") || this.hasTrigger("focus"))) ||
                        (this.submenuOpen = !this.submenuOpen)));
        }
        onKeydown(e) {
            !this.disabled &&
                this.hasSubmenu &&
                (this.submenuOpen || "Enter" !== e.key || (e.stopPropagation(), (this.submenuOpen = !0)),
                this.submenuOpen && "Escape" === e.key && (e.stopPropagation(), (this.submenuOpen = !1)));
        }
        onMouseEnter() {
            !this.disabled &&
                this.hasTrigger("hover") &&
        ...
        updateSubmenuPositioner() {
            ...
            let r = "bottom",
                s = "right";
            e.height() - i.top > n + 8 ? (r = "bottom") : i.top + i.height > n + 8 && (r = "top"),
                ...
                M(this.submenuRef.value).css({
                    ...
                    transformOrigin: ["right" === s ? 0 : "100%", "bottom" === r ? 0 : "100%"].join(" "),
                });
        }
        renderInner(e, t) {
            return ft`<slot name="custom">${
                this.selected
                    ...
                    : ft`<slot name="icon" part="icon" class="icon">${
                          t ? ft`<mdui-icon name="${this.icon}" class="i"></mdui-icon>` : Zt
                      }</slot>`
        ...
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.MenuItem.prototype, "disabled", void 0),
        Se([Ot({ reflect: !0 })], e.MenuItem.prototype, "icon", void 0),
        Se([Ot({ reflect: !0, attribute: "end-icon" })], e.MenuItem.prototype, "endIcon", void 0),
        Se([Ot({ reflect: !0, attribute: "end-text" })], e.MenuItem.prototype, "endText", void 0),
        Se([Ot({ reflect: !0, attribute: "selected-icon" })], e.MenuItem.prototype, "selectedIcon", void 0),
        Se(
            [Ot({ type: Boolean, reflect: !0, converter: wi, attribute: "submenu-open" })],
            e.MenuItem.prototype,
            "submenuOpen",
            void 0
        ),
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.MenuItem.prototype, "selected", void 0),
    ...
    (e.Menu = class extends Xt {
        constructor() {
            super(...arguments),
                ...
                (this.definedController = new ki(this, { relatedElements: ["mdui-menu-item"] }));
        }
        get items() {
        ...
        async onSelectsChange() {
            this.isSelectable
                ? this.isSingle && this.setSelectedKeys(this.selectedKeys.slice(0, 1))
        ...
        async onValueChange() {
            ...
            if (e.length)
                if (this.isSingle) {
                    ...
                    this.isMultiple &&
                        this.setSelectedKeys(
                            this.itemsEnabled.filter((t) => e.includes(t.value)).map((e) => e.key)
                        );
        ...
        firstUpdated(e) {
            super.firstUpdated(e),
                this.definedController.whenDefined().then(() => {
                    this.updateFocusable(), (this.lastActiveItem = this.items.find((e) => e.focusable));
                }),
        ...
        setValue(e) {
            this.isSingle || u(this.value) || u(e) ? (this.value = e) : mo(this.value, e) || (this.value = e);
        }
        ...
        selectOne(e) {
            if (this.isMultiple) {
                ...
                t.includes(e.key) ? t.splice(t.indexOf(e.key), 1) : t.push(e.key), this.setSelectedKeys(t);
            }
            this.isSingle &&
        ...
        async focusableOne(e) {
            this.items.forEach((t) => (t.focusable = t.key === e.key)), await xn();
        }
        focusOne(e, t) {
            e.focus(t);
        }
        ...
        async onKeyDown(e) {
            ...
            if (
                ...
                " " === e.key &&
                    ...
                    this.isSelectable &&
                        t.value &&
                        (this.selectOne(t), await this.focusableOne(t), this.focusOne(t))),
        ...
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.Menu.prototype, "dense", void 0),
        Se([Ot({ reflect: !0, attribute: "submenu-trigger" })], e.Menu.prototype, "submenuTrigger", void 0),
        Se(
            [Ot({ type: Number, reflect: !0, attribute: "submenu-open-delay" })],
            e.Menu.prototype,
            "submenuOpenDelay",
            void 0
        ),
        Se(
            [Ot({ type: Number, reflect: !0, attribute: "submenu-close-delay" })],
            e.Menu.prototype,
            "submenuCloseDelay",
            void 0
        ),
        Se([zt()], e.Menu.prototype, "selectedKeys", void 0),
        Se([Nt({ flatten: !0, selector: "mdui-menu-item" })], e.Menu.prototype, "childrenItems", void 0),
        Se(
            [
                Ci("dense"),
                Ci("selects"),
    ...
    (e.NavigationBarItem = class extends Ui(Xi(ji(Xt))) {
        ...
        render() {
            ...
            return ft`<mdui-ripple .noRipple="${!this.active || this.noRipple}" class="${e}" ${zi(
                this.rippleRef
            )}></mdui-ripple>${
                this.href
                    ? this.renderAnchor({ part: "container", className: t, content: this.renderInner() })
        ...
        renderInner() {
            return ft`<div part="indicator" class="indicator"><slot name="badge" part="badge" class="badge"></slot><slot name="active-icon" part="active-icon" class="active-icon">${
                this.activeIcon ? ft`<mdui-icon name="${this.activeIcon}"></mdui-icon>` : Zt
        ...
        Se([Ot({ reflect: !0 })], e.NavigationBarItem.prototype, "icon", void 0),
        Se(
        ...
        Se([Ot({ reflect: !0 })], e.NavigationBarItem.prototype, "value", void 0),
    ...
    (e.NavigationBar = class extends $i(Pi) {
        constructor() {
            super(...arguments),
                ...
                (this.activeKey = 0),
                (this.isInitial = !0),
                (this.definedController = new ki(this, { relatedElements: ["mdui-navigation-bar-item"] }));
        }
        get scrollPaddingPosition() {
            return "bottom";
        }
        ...
        async onValueChange() {
            (this.isInitial = !this.hasUpdated), await this.definedController.whenDefined();
        ...
        onClick(e) {
            ...
            t && ((this.activeKey = t.key), (this.isInitial = !1), this.updateItems());
        }
        updateItems() {
            const e = this.items,
                t =
        ...
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.NavigationBar.prototype, "hide", void 0),
        Se(
    ...
    (e.NavigationDrawer = class extends Pi {
        ...
        async onMobileChange() {
            !this.open ||
                ...
                (await this.definedController.whenDefined(),
                this.isModal
                    ? (To(this, this.lockTarget), await this.getLockTargetAnimate(!1, 0))
                    : (Do(this, this.lockTarget), await this.getLockTargetAnimate(!0, 0)));
        }
        async onOpenChange() {
            ...
            const i = "right" === this.placement,
                ...
                s = async () => {
                    const i = [];
                    if (
                        (this.isModal ? i.push(t, e) : this.isParentLayout || i.push(this.lockTarget),
                        this.isParentLayout)
                    ) {
                    ...
                    this.isModal || i.includes(this) || i.push(this), await Promise.all(i.map((e) => yo(e)));
                };
            if (this.open) {
                const a = this.hasUpdated;
                if (
                    (a || (await this.updateComplete, (e = this.panelRef.value), (t = this.overlayRef.value)),
                    a)
                ) {
                    if (!this.emit("open", { cancelable: !0 })) return;
                }
                await this.definedController.whenDefined(),
                    ...
                    (this.originalTrigger = document.activeElement),
                    this.isModal &&
                        (this.modalHelper.activate(), this.contained || To(this, this.lockTarget)),
                    await s(),
                    requestAnimationFrame(() => {
                        const t = this.querySelector("[autofocus]");
                        t ? t.focus({ preventScroll: !0 }) : e.focus({ preventScroll: !0 });
                    });
                ...
                if (
                    (this.isModal
                        ? c.push(
                              bo(t, [{ opacity: 0 }, { opacity: 1, offset: 0.3 }, { opacity: 1 }], {
                                  duration: a ? l : 0,
                                  easing: o,
                              })
                          )
                        : this.isParentLayout || c.push(this.getLockTargetAnimate(!0, a ? l : 0)),
                    this.isParentLayout && a && (r(l, n), this.layoutManager.updateLayout(this)),
                    c.push(
                        bo(
                            this.isModal ? e : this,
                            [
                ...
                if (
                    (this.isModal
                        ? c.push(bo(t, [{ opacity: 1 }, { opacity: 0 }], { duration: a, easing: o }))
                        : this.isParentLayout || c.push(this.getLockTargetAnimate(!1, a)),
                    this.isParentLayout && (r(a, n), this.layoutManager.updateLayout(this, { width: 0 })),
                    c.push(
                        bo(
                            this.isModal ? e : this,
                            [
                ...
                this.isParentLayout && r(null),
                    (this.style.display = "none"),
                    this.isModal && !this.contained && Do(this, this.lockTarget);
        ...
        disconnectedCallback() {
            super.disconnectedCallback(), Do(this, this.lockTarget), this.observeResize?.unobserve();
        }
        firstUpdated(e) {
            super.firstUpdated(e),
                this.addEventListener("keydown", (e) => {
        ...
        render() {
            return ft`${go(
                this.isModal,
                () =>
                    ft`<div ${zi(this.overlayRef)} part="overlay" class="overlay" @click="${
                        this.onOverlayClick
                    }"></div>`
            )}<slot ${zi(this.panelRef)} part="panel" class="panel" tabindex="0"></slot>`;
        }
        setObserveResize() {
            this.observeResize = Ti(this.contained ? this.parentElement : document.documentElement, () => {
                const e = this.contained ? this.parentElement : void 0;
                (this.mobile = On(e).down("md")),
                    this.isParentLayout &&
                        this.layoutManager.updateLayout(this, { width: this.isModal ? 0 : void 0 });
            });
        }
        onOverlayClick() {
            this.emit("overlay-click"), this.closeOnOverlayClick && (this.open = !1);
        ...
        getLockTargetAnimate(e, t) {
            ...
            return bo(this.lockTarget, [{ [i]: e ? 0 : o }, { [i]: e ? o : 0 }], {
                duration: t,
        ...
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.NavigationDrawer.prototype, "open", void 0),
        Se(
            [Ot({ type: Boolean, reflect: !0, converter: wi })],
        ...
        Se([Ot({ reflect: !0 })], e.NavigationDrawer.prototype, "placement", void 0),
        Se(
            [Ot({ type: Boolean, reflect: !0, converter: wi })],
            e.NavigationDrawer.prototype,
            "contained",
        ...
        Se([Ci("contained", !0)], e.NavigationDrawer.prototype, "onContainedChange", null),
    ...
    (e.NavigationRail = class extends Pi {
        constructor() {
            super(...arguments),
                ...
                (this.definedController = new ki(this, { relatedElements: ["mdui-navigation-rail-item"] })),
                (this.isInitial = !0);
        }
        get layoutPlacement() {
            return this.placement;
        ...
        render() {
            ...
            return ft`${go(
                ...
                this.onSlotChange
            }" @click="${this.onClick}"></slot><span class="bottom-spacer"></span> ${go(
                t,
        ...
        Se([Ot({ reflect: !0 })], e.NavigationRail.prototype, "placement", void 0),
        Se([Ot({ reflect: !0 })], e.NavigationRail.prototype, "alignment", void 0),
        Se(
            [Ot({ type: Boolean, reflect: !0, converter: wi })],
    ...
    (e.NavigationRailItem = class extends Ui(Xi(ji(Xt))) {
        ...
        render() {
            ...
            return ft`${
                this.href
                    ? this.renderAnchor({ part: "container", className: t, content: this.renderInner(e) })
                    : ft`<div part="container" class="${t}">${this.renderInner(e)}</div>`
            }<mdui-ripple .noRipple="${!this.active || this.noRipple}" ${zi(this.rippleRef)}></mdui-ripple>`;
        }
        renderInner(e) {
            return ft`<div part="indicator" class="indicator"><slot name="badge" part="badge" class="${Wi({
                ...
                this.icon ? ft`<mdui-icon name="${this.icon}"></mdui-icon>` : Zt
            }</slot></div>${e ? ft`<slot part="label" class="label"></slot>` : gt}`;
        }
    }),
        (e.NavigationRailItem.styles = [Qt, Fn]),
        Se([Ot({ reflect: !0 })], e.NavigationRailItem.prototype, "icon", void 0),
        Se(
            [Ot({ reflect: !0, attribute: "active-icon" })],
        ...
        Se([Ot({ reflect: !0 })], e.NavigationRailItem.prototype, "value", void 0),
        Se(
            [Ot({ type: Boolean, reflect: !0, converter: wi })],
            e.NavigationRailItem.prototype,
            "active",
    ...
    (e.Radio = class extends Xi(ji(Xt)) {
        ...
        render() {
            ...
            return ft`<i part="control" class="${e}"><mdui-ripple ${zi(this.rippleRef)} .noRipple="${
                this.noRipple
            }"></mdui-ripple><slot name="unchecked-icon" part="unchecked-icon" class="icon unchecked-icon">${
                this.uncheckedIcon
                    ? ft`<mdui-icon name="${this.uncheckedIcon}" class="i"></mdui-icon>`
        ...
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.Radio.prototype, "disabled", void 0),
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.Radio.prototype, "checked", void 0),
        Se([Ot({ reflect: !0, attribute: "unchecked-icon" })], e.Radio.prototype, "uncheckedIcon", void 0),
        Se([Ot({ reflect: !0, attribute: "checked-icon" })], e.Radio.prototype, "checkedIcon", void 0),
        Se([zt()], e.Radio.prototype, "invalid", void 0),
        Se(
            [Ot({ type: Boolean, reflect: !0, converter: wi, attribute: "group-disabled" })],
            e.Radio.prototype,
            "groupDisabled",
            void 0
        ),
    ...
    (e.RadioGroup = class extends Xt {
        constructor() {
            super(...arguments),
                ...
                (this.inputRef = _i()),
                (this.formController = new Hi(this)),
                (this.definedController = new ki(this, { relatedElements: ["mdui-radio"] }));
        }
        get validity() {
            return this.inputRef.value.validity;
        }
        ...
        render() {
            return ft`<fieldset><input ${zi(this.inputRef)} type="radio" class="input" name="${Ft(
                this.name
            )}" value="${Ft(this.value)}" .checked="${!!this.value}" .required="${
                this.required
            }" tabindex="-1" @keydown="${this.onKeyDown}"><slot @click="${this.onClick}" @keydown="${
                this.onKeyDown
            }" @slotchange="${this.onSlotChange}" @change="${this.onCheckedChange}"></slot></fieldset>`;
        }
        ...
        async onClick(e) {
            ...
            t && !t.disabled && ((this.value = t.value), await this.updateComplete, t.focus());
        }
        async onKeyDown(e) {
        ...
        async onSlotChange() {
            await this.definedController.whenDefined(), this.updateItems(), this.updateRadioFocusable();
        }
        onCheckedChange(e) {
            e.stopPropagation();
        }
        ...
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.RadioGroup.prototype, "disabled", void 0),
        ...
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.RadioGroup.prototype, "required", void 0),
    ...
    class Wn extends Xi(ji(Xt)) {
        ...
        getCandidateValues() {
            return Array.from({ length: this.max - this.min + 1 }, (e, t) => t + this.min).filter(
                (e) => !((e - this.min) % this.step)
            );
        }
        renderLabel(e) {
            return go(
    ...
    (Wn.styles = [Qt, jn]),
        ...
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], Wn.prototype, "tickmarks", void 0),
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], Wn.prototype, "nolabel", void 0),
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], Wn.prototype, "disabled", void 0),
            ...
            firstUpdated(e) {
                ...
                this.addEventListener("touchstart", i),
                    ...
                    this.addEventListener("pointermove", (e) => {
                        const i = t(e);
                        this.hoverHandle !== i &&
                            (this.endHover(e), (this.hoverHandle = i), this.startHover(e));
                    }),
                    this.updateStyle();
            }
            render() {
                return ft`<label class="${Wi({ invalid: this.invalid })}"><input ${zi(
                    this.inputRef
                )} type="range" step="${this.step}" min="${this.min}" max="${this.max}" ?disabled="${
                    this.disabled
                ...
                })}"><div class="elevation"></div><mdui-ripple ${zi(this.rippleStartRef)} .noRipple="${
                    this.noRipple
                }"></mdui-ripple>${this.renderLabel(this.value[0])}</div><div ${zi(
                    this.handleEndRef
                )} part="handle" class="handle end" style="${Yt({
                    "z-index": "end" === this.currentHandle ? "2" : "1",
                })}"><div class="elevation"></div><mdui-ripple ${zi(this.rippleEndRef)} .noRipple="${
                    this.noRipple
                }"></mdui-ripple>${this.renderLabel(this.value[1])}</div>${go(this.tickmarks, () =>
                    qn(
        ...
        Se([Ot({ type: Array, attribute: !1 })], e.RangeSlider.prototype, "value", null),
    ...
    (e.SegmentedButton = class extends Zi {
        ...
        renderIcon() {
            return this.loading
                ...
                : ft`<slot name="icon" part="icon" class="icon">${
                      this.icon ? ft`<mdui-icon name="${this.icon}" class="i"></mdui-icon>` : Zt
                  }</slot>`;
        }
        renderLabel() {
            return this.hasSlotController.test("[default]")
        ...
        Se([Ot({ reflect: !0, attribute: "end-icon" })], e.SegmentedButton.prototype, "endIcon", void 0),
        Se(
    ...
    (e.SegmentedButtonGroup = class extends Xt {
        constructor() {
            super(...arguments),
                ...
                (this.inputRef = _i()),
                (this.formController = new Hi(this)),
                (this.definedController = new ki(this, { relatedElements: ["mdui-segmented-button"] }));
        }
        get validity() {
            return this.inputRef.value.validity;
        }
        ...
        connectedCallback() {
            super.connectedCallback(),
                (this.value =
                    this.isMultiple && c(this.value) ? (this.value ? [this.value] : []) : this.value),
            ...
            return ft`${go(
                ...
                () =>
                    ft`<input ${zi(this.inputRef)} type="radio" name="${Ft(
                        this.name
                    )}" value="1" .disabled="${this.disabled}" .required="${this.required}" .checked="${!!this
                        .value}" tabindex="-1" @keydown="${this.onInputKeyDown}">`
            )}${go(
                this.isSelectable && this.isMultiple,
                () =>
                    ft`<select ${zi(this.inputRef)} name="${Ft(this.name)}" .disabled="${
                        this.disabled
                    }" .required="${this.required}" multiple="multiple" tabindex="-1" @keydown="${
                        this.onInputKeyDown
                    }">${qn(
                        this.value,
                        (e) => ft`<option selected="selected" value="${e}"></option>`
                    )}</select>`
        ...
        async onInputKeyDown(e) {
            if (["Enter", " "].includes(e.key)) {
                if ((e.preventDefault(), await this.definedController.whenDefined(), this.isSingle)) {
                    const t = e.target;
                    (t.checked = !t.checked),
                        this.selectOne(this.itemsEnabled[0]),
                        this.itemsEnabled[0].focus();
                }
                this.isMultiple && (this.selectOne(this.itemsEnabled[0]), this.itemsEnabled[0].focus());
            }
        }
        async onSlotChange() {
        ...
        setValue(e) {
            this.isSingle ? (this.value = e) : mo(this.value, e) || (this.value = e);
        }
        updateItems(e = !1) {
            const t = this.items;
            t.forEach((i, o) => {
                (i.invalid = this.invalid),
                    ...
                    e &&
                        (i.classList.toggle("mdui-segmented-button-first", 0 === o),
        ...
        Se([Ot({ reflect: !0 })], e.SegmentedButtonGroup.prototype, "selects", void 0),
        Se(
            [Ot({ type: Boolean, reflect: !0, converter: wi })],
            e.SegmentedButtonGroup.prototype,
            "disabled",
        ...
        Se([Ot({ reflect: !0 })], e.SegmentedButtonGroup.prototype, "form", void 0),
        Se([Ot({ reflect: !0 })], e.SegmentedButtonGroup.prototype, "name", void 0),
    ...
    (e.TextField = class extends ji(Xt) {
        ...
        async onValueChange() {
            if (((this.hasValue = !["", null].includes(this.value)), this.hasUpdated)) {
        ...
        connectedCallback() {
            super.connectedCallback(),
                this.updateComplete.then(() => {
                    this.setTextareaHeight(),
                        (this.observeResize = Ti(this.inputRef.value, () => this.setTextareaHeight()));
                });
        }
        disconnectedCallback() {
            super.disconnectedCallback(), this.observeResize?.unobserve(), hn(this);
        }
        select() {
        ...
        reportValidity() {
            return (
                ...
                this.invalid &&
                    (this.emit("invalid", { bubbles: !1, cancelable: !0, composed: !1 }), this.focus()),
                !this.invalid
            );
        }
        setCustomValidity(e) {
        ...
        render() {
            const e = !!this.icon || this.hasSlotController.test("icon"),
                ...
                o = "password" === this.type && this.togglePassword && !this.disabled,
                n =
                    this.clearable &&
                    !this.disabled &&
                ...
                l = i && !(!this.error && !this.inputRef.value.validationMessage),
                c = this.counter && !!this.maxlength,
                d = this.hasSlotController.test("input"),
                h = { invalid: this.invalid, "invalid-style": this.invalidStyle },
                u = Wi({
                    container: !0,
            ...
            )}</div>${this.renderSuffix()}${this.renderClearButton(n)} ${this.renderTogglePasswordButton(
                o
            )} ${this.renderRightIcon(i)}</div>${go(
                l || a || c,
                () =>
                    ft`<div part="supporting" class="${Wi({ supporting: !0, ...h })}">${this.renderHelper(
                        l,
                        a
                    )} ${this.renderCounter(c)}</div>`
            )}`;
        }
        ...
        getPatternErrorMsg() {
            return tn("Please match the requested format.", { id: "components.textField.patternError" });
        }
        setTextareaHeight() {
            this.autosize
        ...
        renderLabel() {
            return this.label ? ft`<label part="label" class="label">${this.label}</label>` : Zt;
        }
        renderPrefix() {
            return ft`<slot name="icon" part="icon" class="icon">${
                this.icon ? ft`<mdui-icon name="${this.icon}" class="i"></mdui-icon>` : Zt
            }</slot><slot name="prefix" part="prefix" class="prefix">${this.prefix}</slot>`;
        }
        renderSuffix() {
        ...
        renderInput(e) {
            return ft`<input ${zi(this.inputRef)} part="input" class="input ${Wi({
                "hide-input": e,
            })}" type="${"password" === this.type && this.isPasswordVisible ? "text" : this.type}" name="${Ft(
                this.name
            )}" .value="${io(this.value)}" placeholder="${Ft(
                !this.label || this.isFocusedStyle || this.hasValue ? this.placeholder : void 0
            )}" ?readonly="${this.readonly}" ?disabled="${this.disabled}" ?required="${
                this.required
            }" minlength="${Ft(this.minlength)}" maxlength="${Ft(this.maxlength)}" min="${Ft(
                this.min
            )}" max="${Ft(this.max)}" step="${Ft(this.step)}" autocapitalize="${Ft(
            ...
            )}" spellcheck="${Ft(this.spellcheck)}" pattern="${Ft(this.pattern)}" enterkeyhint="${Ft(
                this.enterkeyhint
            )}" inputmode="${Ft(this.inputmode)}" @change="${this.onChange}" @input="${
                this.onInput
            }" @invalid="${this.onInvalid}" @keydown="${this.onKeyDown}">`;
        }
        renderTextArea(e) {
            return ft`<textarea ${zi(this.inputRef)} part="input" class="input ${Wi({
                "hide-input": e,
            })}" name="${Ft(this.name)}" .value="${io(this.value)}" placeholder="${Ft(
                !this.label || this.isFocusedStyle || this.hasValue ? this.placeholder : void 0
            )}" ?readonly="${this.readonly}" ?disabled="${this.disabled}" ?required="${
                this.required
            }" minlength="${Ft(this.minlength)}" maxlength="${Ft(this.maxlength)}" rows="${
                this.rows ?? 1
            }" autocapitalize="${Ft(this.autocapitalize)}" autocorrect="${Ft(
                this.autocorrect
            )}" spellcheck="${Ft(this.spellcheck)}" enterkeyhint="${Ft(this.enterkeyhint)}" inputmode="${Ft(
                this.inputmode
            )}" @change="${this.onChange}" @input="${this.onInput}" @invalid="${this.onInvalid}" @keydown="${
                this.onKeyDown
        ...
        Se(
            [Ot({ type: Boolean, reflect: !0, converter: wi, attribute: "helper-on-focus" })],
            e.TextField.prototype,
            "helperOnFocus",
            void 0
        ),
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.TextField.prototype, "clearable", void 0),
        Se([Ot({ reflect: !0, attribute: "clear-icon" })], e.TextField.prototype, "clearIcon", void 0),
        Se(
            [Ot({ type: Boolean, reflect: !0, converter: wi, attribute: "end-aligned" })],
            e.TextField.prototype,
            "endAligned",
            void 0
        ),
        ...
        Se([Ot({ reflect: !0, attribute: "end-icon" })], e.TextField.prototype, "endIcon", void 0),
        Se([Ot({ reflect: !0, attribute: "error-icon" })], e.TextField.prototype, "errorIcon", void 0),
        Se([Ot({ reflect: !0 })], e.TextField.prototype, "form", void 0),
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.TextField.prototype, "readonly", void 0),
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.TextField.prototype, "disabled", void 0),
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.TextField.prototype, "required", void 0),
        Se([Ot({ type: Number, reflect: !0 })], e.TextField.prototype, "rows", void 0),
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.TextField.prototype, "autosize", void 0),
        Se(
        ...
        Se([Ot({ type: Number, reflect: !0 })], e.TextField.prototype, "minlength", void 0),
        Se([Ot({ type: Number, reflect: !0 })], e.TextField.prototype, "maxlength", void 0),
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.TextField.prototype, "counter", void 0),
        Se([Ot({ type: Number, reflect: !0 })], e.TextField.prototype, "min", void 0),
        Se([Ot({ type: Number, reflect: !0 })], e.TextField.prototype, "max", void 0),
        Se([Ot({ type: Number, reflect: !0 })], e.TextField.prototype, "step", void 0),
        Se([Ot({ reflect: !0 })], e.TextField.prototype, "pattern", void 0),
        Se(
            [Ot({ type: Boolean, reflect: !0, converter: wi, attribute: "toggle-password" })],
            e.TextField.prototype,
            "togglePassword",
            void 0
        ),
        ...
        Se([Ot({ reflect: !0 })], e.TextField.prototype, "autocapitalize", void 0),
        Se([Ot({ reflect: !0 })], e.TextField.prototype, "autocorrect", void 0),
        Se([Ot({ reflect: !0 })], e.TextField.prototype, "autocomplete", void 0),
        Se([Ot({ reflect: !0 })], e.TextField.prototype, "enterkeyhint", void 0),
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.TextField.prototype, "spellcheck", void 0),
        ...
        Se(
            [Ot({ type: Boolean, reflect: !0, converter: wi, attribute: "focused-style" })],
            e.TextField.prototype,
            "focusedStyle",
            void 0
        ),
    ...
    (e.Select = class extends ji(Xt) {
        ...
        connectedCallback() {
            super.connectedCallback(),
                ...
                this.updateComplete.then(() => {
                    this.observeResize = Ti(this.textFieldRef.value, () => this.resizeMenu());
                });
        }
        disconnectedCallback() {
        ...
        render() {
            ...
            return ft`${
                this.multiple
                    ? ft`<select ${zi(this.hiddenInputRef)} class="hidden-input" name="${Ft(
                          this.name
                      )}" value="${Ft(this.value)}" .required="${this.required}" .disabled="${
                          this.disabled
                      }" multiple="multiple" tabindex="-1">${qn(
                          this.value,
                          (e) => ft`<option selected="selected" value="${e}"></option>`
                      )}</select>`
                    : ft`<input ${zi(this.hiddenInputRef)} type="radio" class="hidden-input" name="${Ft(
                          this.name
                      )}" value="${Ft(this.value)}" .required="${this.required}" .disabled="${
                          this.disabled
                ...
                "top" === this.placement ? "top-start" : "bottom" === this.placement ? "bottom-start" : "auto"
            }" @open="${this.onDropdownOpen}" @close="${this.onDropdownClose}"><mdui-text-field ${zi(
                this.textFieldRef
                ...
                .join(",")}" readonly="readonly" .readonlyButClearable="${!0}" .variant="${
                this.variant
            }" .name="${this.name}" .value="${
                this.multiple ? (this.value.length ? " " : "") : this.getMenuItemLabelByValue(this.value)
            }" .label="${this.label}" .placeholder="${this.placeholder}" .helper="${this.helper}" .error="${
                this.hiddenInputRef.value?.validationMessage
            }" .clearable="${this.clearable}" .clearIcon="${this.clearIcon}" .endAligned="${
                this.endAligned
            }" .prefix="${this.prefix}" .suffix="${this.suffix}" .icon="${this.icon}" .endIcon="${
                this.endIcon
            }" .errorIcon="${this.errorIcon}" .form="${this.form}" .disabled="${this.disabled}" .required="${
                this.required
            }" .invalidStyle="${this.invalid}" @clear="${this.onClear}" @change="${(e) =>
                e.stopPropagation()}" @keydown="${this.onTextFieldKeyDown}">${qn(
                [
                    "icon",
                    "end-icon",
                    "error-icon",
                ...
                (e) => (this.hasSlotController.test(e) ? ft`<slot name="${e}" slot="${e}"></slot>` : gt)
            )} ${go(
                    ...
                    ft`<div slot="input" class="chips" part="chips">${qn(
                        ...
                        (e) =>
                            ft`<mdui-chip class="chip" part="chip" exportparts="${[
                                ...
                                .map((e) => `${e}:chip__${e}`)
                                .join(",")}" variant="input" deletable tabindex="-1" @delete="${() =>
                                this.onDeleteOneValue(e)}">${this.getMenuItemLabelByValue(e)}</mdui-chip>`
                    )}</div>`
            )}</mdui-text-field><mdui-menu ${zi(this.menuRef)} part="menu" .selects="${
        ...
        getMenuItemLabelByValue(e) {
            return (
                (this.menuItems.length && this.menuItems.find((t) => t.value === e)?.textContent?.trim()) || e
            );
        }
        resizeMenu() {
        ...
        onTextFieldKeyDown(e) {
            "Enter" === e.key && (e.preventDefault(), this.textFieldRef.value.click());
        }
    }),
        (e.Select.styles = [Qt, tr]),
        Se([Ot({ reflect: !0 })], e.Select.prototype, "variant", void 0),
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.Select.prototype, "multiple", void 0),
        ...
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.Select.prototype, "clearable", void 0),
        Se([Ot({ reflect: !0, attribute: "clear-icon" })], e.Select.prototype, "clearIcon", void 0),
        ...
        Se([Ot({ reflect: !0, attribute: "end-icon" })], e.Select.prototype, "endIcon", void 0),
        Se([Ot({ reflect: !0, attribute: "error-icon" })], e.Select.prototype, "errorIcon", void 0),
        Se([Ot({ reflect: !0 })], e.Select.prototype, "form", void 0),
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.Select.prototype, "readonly", void 0),
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.Select.prototype, "disabled", void 0),
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.Select.prototype, "required", void 0),
        Se([zt()], e.Select.prototype, "invalid", void 0),
        Se([Nt({ flatten: !0, selector: "mdui-menu-item" })], e.Select.prototype, "menuItems", void 0),
    ...
    (e.Slider = class extends Wn {
        ...
        render() {
            return ft`<label class="${Wi({ invalid: this.invalid })}"><input ${zi(
                ...
                this.disabled
            }" .value="${io(this.value.toString())}" @input="${this.onInput}" @change="${
                this.onChange
            }"><div part="track-inactive" class="track-inactive"></div><div ${zi(
                this.trackActiveRef
            )} part="track-active" class="track-active"></div><div ${zi(
                ...
                this.rippleRef
            )} .noRipple="${this.noRipple}"></mdui-ripple>${this.renderLabel(this.value)}</div>${go(
                this.tickmarks,
                () =>
                    qn(
                        this.getCandidateValues(),
        ...
        updateStyle() {
            ...
            (this.trackActiveRef.value.style.width = `${e}%`), (this.handleRef.value.style.left = `${e}%`);
        }
        onInput() {
            (this.value = parseFloat(this.inputRef.value.value)), this.updateStyle();
        }
    }),
    ...
    (e.Snackbar = class extends Xt {
        ...
        async onOpenChange() {
            const e = xo(this, "linear"),
                t = Array.from(this.renderRoot.querySelectorAll(".message, .action-group"));
            if (this.open) {
                const i = this.hasUpdated;
                ...
                return (
                    await Promise.all([
                        bo(this, [{ opacity: 0 }, { opacity: 1, offset: 0.5 }, { opacity: 1 }], {
                            duration: i ? o : 0,
                            easing: e,
                            fill: "forwards",
                        }),
            ...
            if (!this.open && this.hasUpdated) {
                if (!this.emit("close", { cancelable: !0 })) return;
                window.clearTimeout(this.closeTimeout), await Promise.all([yo(this), ...t.map((e) => yo(e))]);
                const i = $o(this, "short4");
                await Promise.all([
                    bo(this, [{ opacity: 1 }, { opacity: 0 }], { duration: i, easing: e, fill: "forwards" }),
                    ...t.map((t) =>
                        bo(t, [{ opacity: 1 }, { opacity: 0, offset: 0.75 }, { opacity: 0 }], {
                            duration: i,
                            easing: e,
                ...
                return nr.splice(o, 1), void (nr[o] && (await this.reorderStack(nr[o].snackbar)));
            }
        }
        async onStackChange() {
            await this.reorderStack(this);
        ...
        connectedCallback() {
            super.connectedCallback(),
                ...
                (this.observeResize = Ti(document.documentElement, async () => {
                    const e = On().down("sm");
                    this.mobile !== e &&
                        ((this.mobile = e), rr || ((rr = !0), await this.reorderStack(), (rr = !1)));
                }));
        }
        disconnectedCallback() {
            super.disconnectedCallback(),
        ...
        async reorderStack(e) {
            for (let t = e ? nr.findIndex((t) => t.snackbar === e) : 0; t < nr.length; t++) {
                const e = nr[t].snackbar;
                this.mobile
                    ? ["top", "bottom"].forEach((i) => {
                          if (e.placement.startsWith(i)) {
                              const o = nr.filter((e, o) => o < t && e.snackbar.placement.startsWith(i)),
                                  n = o.reduce((e, t) => e + t.height, 0);
                              (e.style[i] = `calc(${n}px + ${o.length + 1}rem)`),
                                  (e.style["top" === i ? "bottom" : "top"] = "auto");
                          }
                      })
                    : ["top", "top-start", "top-end", "bottom", "bottom-start", "bottom-end"].forEach((i) => {
                          if (e.placement === i) {
                              const o = nr.filter((e, o) => o < t && e.snackbar.placement === i),
                                  n = o.reduce((e, t) => e + t.height, 0);
                              (e.style[i.startsWith("top") ? "top" : "bottom"] = `calc(${n}px + ${
                                  o.length + 1
                              }rem)`),
                                  (e.style[i.startsWith("top") ? "bottom" : "top"] = "auto");
                          }
                      });
            }
        }
        ...
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.Snackbar.prototype, "open", void 0),
        Se([Ot({ reflect: !0 })], e.Snackbar.prototype, "placement", void 0),
        Se([Ot({ reflect: !0, attribute: "action" })], e.Snackbar.prototype, "action", void 0),
        Se(
            [Ot({ type: Boolean, reflect: !0, converter: wi, attribute: "action-loading" })],
            e.Snackbar.prototype,
            "actionLoading",
            void 0
        ),
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.Snackbar.prototype, "closeable", void 0),
        Se([Ot({ reflect: !0, attribute: "close-icon" })], e.Snackbar.prototype, "closeIcon", void 0),
        Se(
        ...
        Se(
            [Ot({ type: Boolean, reflect: !0, attribute: "close-on-outside-click", converter: wi })],
            e.Snackbar.prototype,
            "closeOnOutsideClick",
            void 0
        ),
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.Snackbar.prototype, "mobile", void 0),
        Se([Ci("open")], e.Snackbar.prototype, "onOpenChange", null),
        Se([Ci("placement", !0), Ci("messageLine", !0)], e.Snackbar.prototype, "onStackChange", null),
    ...
    (e.Switch = class extends Xi(ji(Xt)) {
        ...
        render() {
            return ft`<label class="${Wi({
            ...
            })}"><input ${zi(this.inputRef)} type="checkbox" name="${Ft(this.name)}" value="${Ft(
                this.value
            )}" .disabled="${this.disabled}" .checked="${io(this.checked)}" .required="${
                this.required
            }" @change="${
                ...
                this.uncheckedIcon ? ft`<mdui-icon name="${this.uncheckedIcon}" class="i"></mdui-icon>` : Zt
            }</slot></div></div></label>`;
        }
        onChange() {
        ...
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.Switch.prototype, "disabled", void 0),
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.Switch.prototype, "checked", void 0),
        Se([oo("checked")], e.Switch.prototype, "defaultChecked", void 0),
        Se([Ot({ reflect: !0, attribute: "unchecked-icon" })], e.Switch.prototype, "uncheckedIcon", void 0),
        Se([Ot({ reflect: !0, attribute: "checked-icon" })], e.Switch.prototype, "checkedIcon", void 0),
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.Switch.prototype, "required", void 0),
    ...
    (e.Tab = class extends Xi(ji(Xt)) {
        ...
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.Tab.prototype, "inline", void 0),
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.Tab.prototype, "active", void 0),
    ...
    (e.TabPanel = class extends Xt {
        ...
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.TabPanel.prototype, "active", void 0),
    ...
    (e.Tabs = class extends Xt {
        constructor() {
            super(...arguments),
                ...
                (this.definedController = new ki(this, { relatedElements: ["mdui-tab", "mdui-tab-panel"] }));
        }
        async onActiveKeyChange() {
            await this.definedController.whenDefined(),
        ...
        connectedCallback() {
            super.connectedCallback(),
                this.updateComplete.then(() => {
                    this.observeResize = Ti(this.containerRef.value, () => this.updateIndicator());
                });
        }
        disconnectedCallback() {
            super.disconnectedCallback(), this.observeResize?.unobserve();
        ...
        render() {
            return ft`<div ${zi(this.containerRef)} part="container" class="container ${Wi({
                initial: this.isInitial,
            })}"><slot @slotchange="${this.onSlotChange}" @click="${this.onClick}"></slot><div ${zi(
                this.indicatorRef
        ...
        async onClick(e) {
            ...
            t && ((this.activeKey = t.key), (this.isInitial = !1), this.updateActive());
        }
        updateActive() {
        ...
        updateIndicator() {
            ...
            if (!e) return void t.css({ transform: i ? "scaleY(0)" : "scaleX(0)" });
            const o = M(e),
                n = e.offsetTop,
                r = e.offsetLeft,
                s = i
            ...
            if ("primary" === this.variant) {
                ...
                if (i) {
                    ...
                    a = { top: e, height: Math.max(...s.map((e) => e.offsetTop + e.offsetHeight)) + n - e };
                } else {
                    const e = Math.min(...s.map((e) => e.offsetLeft)) + r;
                    a = { left: e, width: Math.max(...s.map((e) => e.offsetLeft + e.offsetWidth)) + r - e };
                }
            }
            "secondary" === this.variant &&
                (a = i ? { top: n, height: e.offsetHeight } : { left: r, width: e.offsetWidth }),
                t.css({ ...s, ...a });
        }
    }),
        (e.Tabs.styles = [Qt, cr]),
        ...
        Se([Nt({ selector: "mdui-tab", flatten: !0 })], e.Tabs.prototype, "tabs", void 0),
        Se(
                ...
                M(this.elementRef.value)
                    .on(this.enterEventName, () => {
                        ...
                        for (let e = this.mouseEnterItems.length - 1; e >= 0; e--) {
                            ...
                            t.callback(), t.one && this.mouseEnterItems.splice(e, 1);
                        }
                    })
                    .on(this.leaveEventName, () => {
                        ...
                        for (let e = this.mouseLeaveItems.length - 1; e >= 0; e--) {
                            ...
                            t.callback(), t.one && this.mouseLeaveItems.splice(e, 1);
                        }
                    });
            });
        }
    ...
    (e.Tooltip = class extends Xt {
        ...
        get target() {
            return [...this.children].find(
                (e) => "style" !== e.tagName.toLowerCase() && "content" !== e.getAttribute("slot")
            );
        }
        async onPositionChange() {
            this.open && (await this.definedController.whenDefined(), this.updatePositioner());
        ...
        async onOpenChange() {
            ...
            if (this.open) {
                ...
                return (
                    ...
                    this.updatePositioner(),
                    await bo(this.popupRef.value, [{ transform: "scale(0)" }, { transform: "scale(1)" }], {
                        duration: e ? t : 0,
                        easing: i,
                    }),
            ...
            if (!this.open && e) {
                if (!this.emit("close", { cancelable: !0 })) return;
                await yo(this.popupRef.value),
                    await bo(this.popupRef.value, [{ transform: "scale(1)" }, { transform: "scale(0)" }], {
                        duration: t,
                        easing: i,
                    }),
        ...
        render() {
            ...
            return ft`<slot></slot><div ${zi(this.popupRef)} part="popup" class="popup" hidden>${go(
                e,
                () => ft`<slot name="headline" part="headline" class="headline">${this.headline}</slot>`
            )}<slot name="content" part="content" class="content">${this.content}</slot>${go(
                t,
        ...
        onKeydown(e) {
            !this.disabled && this.open && "Escape" === e.key && (e.stopPropagation(), this.requestClose());
        }
        onMouseEnter() {
            this.disabled ||
                this.open ||
        ...
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.Tooltip.prototype, "disabled", void 0),
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.Tooltip.prototype, "open", void 0),
    ...
    (e.TopAppBarTitle = class extends Xt {
        ...
        render() {
            ...
            return ft`<slot part="label" class="label ${t}" ${zi(this.defaultSlotRef)} @slotchange="${() =>
                this.onSlotChange(e)}"></slot>${
                e
                    ? ft`<slot name="label-large" part="label-large" class="label-large ${t}"></slot>`
                    : ft`<div ${zi(this.labelLargeRef)} part="label-large" class="label-large ${t}"></div>`
            }`;
        }
        onSlotChange(e) {
            e ||
    ...
    (e.TopAppBar = class extends $i(Pi) {
        ...
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.TopAppBar.prototype, "hide", void 0),
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.TopAppBar.prototype, "shrink", void 0),
        Se(
            [Ot({ reflect: !0, attribute: "scroll-behavior" })],
        ...
        Se([Ot({ type: Boolean, reflect: !0, converter: wi })], e.TopAppBar.prototype, "scrolling", void 0),
        Se(
    ...
    const kr = (t) => {
            const i = new e.Dialog(),
                ...
                r = ["onOpen", "onOpened", "onClose", "onClosed", "onOverlayClick"];
            return (
                ...
                o.appendTo("body").on("closed", (e) => {
                    e.target === i && (o.remove(), t.queue && ((wr = void 0), gr(yr + t.queue)));
                }),
                t.queue
                    ? wr
                        ? vr(yr + t.queue, () => {
    ...
    function Kr(e) {
        const t = e / 255;
        return t <= 0.040449936 ? (t / 12.92) * 100 : 100 * Math.pow((t + 0.055) / 1.055, 2.4);
    }
    function qr(e) {
        const t = e / 100;
        let i = 0;
        return (
            (i = t <= 0.0031308 ? 12.92 * t : 1.055 * Math.pow(t, 1 / 2.4) - 0.055),
            (o = 0),
            (n = 255),
    ...
    class Gr {
        static make(
            ...
            const r = e,
                ...
                c = 0.8 + o / 10,
                d = c >= 0.9 ? Ir(0.59, 0.69, 10 * (c - 0.9)) : Ir(0.525, 0.59, 10 * (c - 0.8));
            ...
            return new Gr(b, (2 * x[0] + x[1] + 0.05 * x[2]) * w, w, k, d, u, p, g, Math.pow(g, 0.25), y);
        }
    ...
    class Yr {
            ...
            const i = (65280 & e) >> 8,
                ...
                P =
                    ((5e4 / 13) *
                        ...
                        Math.sqrt(C * C + x * x)) /
                    ($ + 0.305),
                L = Math.pow(P, 0.9) * Math.pow(1.64 - Math.pow(0.29, t.n), 0.73),
                _ = L * Math.sqrt(D / 100),
                B = _ * t.fLRoot,
        ...
        viewed(e) {
            const t = 0 === this.chroma || 0 === this.j ? 0 : this.chroma / Math.sqrt(this.j / 100),
                i = Math.pow(t / Math.pow(1.64 - Math.pow(0.29, e.n), 0.73), 1 / 0.9),
                ...
                l = Math.sin(o),
                c = Math.cos(o),
                d = (23 * (a + 0.305) * i) / (23 * s + 11 * i * c + 108 * i * l),
                h = d * c,
                u = d * l,
            ...
            const n = 0.401288 * e + 0.650173 * t - 0.051461 * i,
                ...
                S =
                    ((5e4 / 13) *
                        ...
                        Math.sqrt(v * v + g * g)) /
                    (b + 0.305),
                E = Math.pow(S, 0.9) * Math.pow(1.64 - Math.pow(0.29, o.n), 0.73),
                T = E * Math.sqrt($ / 100),
                D = T * o.fLRoot,
    ...
    class Xr {
        ...
        static trueDelinearized(e) {
            const t = e / 100;
            let i = 0;
            return (i = t <= 0.0031308 ? 12.92 * t : 1.055 * Math.pow(t, 1 / 2.4) - 0.055), 255 * i;
        }
            ...
            for (let l = 0; l < 12; l++) {
                ...
                s
                    ? (a || Xr.areInCyclicOrder(n, d, r)) &&
                      ((a = !1), Xr.areInCyclicOrder(n, t, d) ? ((o = c), (r = d)) : ((i = c), (n = d)))
                    : ((i = c), (o = c), (n = d), (r = d), (s = !0));
            }
            return [i, o];
        }
            ...
            for (let e = 0; e < 3; e++)
                if (o[e] !== r[e]) {
                    let i = -1,
                        s = 255;
                    o[e] < r[e]
                        ? ((i = Xr.criticalPlaneBelow(Xr.trueDelinearized(o[e]))),
                          (s = Xr.criticalPlaneAbove(Xr.trueDelinearized(r[e]))))
                        : ((i = Xr.criticalPlaneAbove(Xr.trueDelinearized(o[e]))),
                          (s = Xr.criticalPlaneBelow(Xr.trueDelinearized(r[e]))));
                    for (let a = 0; a < 8 && !(Math.abs(s - i) <= 1); a++) {
                        const a = Math.floor((i + s) / 2),
                            l = Xr.CRITICAL_PLANES[a],
                            c = Xr.setCoordinate(o, l, r, e),
                            d = Xr.hueOf(c);
                        Xr.areInCyclicOrder(n, t, d) ? ((r = c), (s = a)) : ((o = c), (n = d), (i = a));
                    }
                }
        ...
        static findResultByJ(e, t, i) {
            ...
            for (let e = 0; e < 5; e++) {
                const c = o / 100,
                    ...
                    p = (23 * (u + 0.305) * h) / (23 * s + 11 * h * l + 108 * h * a),
                    m = p * l,
                    f = p * a,
                ...
                if (4 === e || Math.abs(x - i) < 0.002)
                    return y[0] > 100.01 || y[1] > 100.01 || y[2] > 100.01 ? 0 : Br(y);
                o -= ((x - i) * o) / (2 * x);
            }
            return 0;
        }
    ...
    class Jr {
        ...
        set hue(e) {
            this.setInternalState(Xr.solveToInt(e, this.internalChroma, this.internalTone));
        }
        get chroma() {
            return this.internalChroma;
        }
        set chroma(e) {
            this.setInternalState(Xr.solveToInt(this.internalHue, e, this.internalTone));
        }
        get tone() {
            return this.internalTone;
        }
        set tone(e) {
            this.setInternalState(Xr.solveToInt(this.internalHue, this.internalChroma, e));
        }
        constructor(e) {
            this.argb = e;
    ...
    class Zr {
        static harmonize(e, t) {
            const i = Jr.fromInt(e),
                ...
                n = Dr(i.hue, o.hue),
                r = Math.min(0.5 * n, 15),
                s = Tr(i.hue + r * ((a = i.hue), Tr(o.hue - a) <= 180 ? 1 : -1));
            var a;
    ...
    class Qr {
        static ratioOfTones(e, t) {
            return (e = Sr(0, 100, e)), (t = Sr(0, 100, t)), Qr.ratioOfYs(Hr(e), Hr(t));
        }
    ...
    class ts {
        ...
        getTone(e) {
            ...
            if (this.toneDeltaPair) {
                const i = this.toneDeltaPair(e),
                    ...
                    v = d.tone(e);
                let g = Qr.ratioOfTones(l, v) >= m ? v : ts.foregroundTone(l, m);
                const b = h.tone(e);
                let y = Qr.ratioOfTones(l, b) >= f ? b : ts.foregroundTone(l, f);
                return (
                    t && ((g = ts.foregroundTone(l, m)), (y = ts.foregroundTone(l, f))),
                    (y - g) * p >= r ||
                        ((y = Sr(0, 100, g + r * p)), (y - g) * p >= r || (g = Sr(0, 100, y - r * p))),
                    50 <= g && g < 60
                        ? p > 0
            ...
            }
            {
                ...
                if (
                    (Qr.ratioOfTones(o, i) >= n || (i = ts.foregroundTone(o, n)),
                    t && (i = ts.foregroundTone(o, n)),
                    this.isBackground && 50 <= i && i < 60 && (i = Qr.ratioOfTones(49, o) >= n ? 49 : 60),
                    ...
                    if (Qr.ratioOfTones(a, i) >= n && Qr.ratioOfTones(l, i) >= n) return i;
                    const c = Qr.lighter(a, n),
                        d = Qr.darker(l, n),
                        h = [];
                    -1 !== c && h.push(c), -1 !== d && h.push(d);
                    return ts.tonePrefersLightForeground(r) || ts.tonePrefersLightForeground(s)
                        ? c < 0
                            ? 100
                            : c
                        : 1 === h.length
        ...
        static enableLightForeground(e) {
            return ts.tonePrefersLightForeground(e) && !ts.toneAllowsLightForeground(e) ? 49 : e;
        }
    }
    class is {
        static fromInt(e) {
        ...
        constructor(e, t, i) {
            (this.hue = e), (this.chroma = t), (this.keyColor = i), (this.cache = new Map());
        }
        tone(e) {
            let t = this.cache.get(e);
            return void 0 === t && ((t = Jr.from(this.hue, this.chroma, e).toInt()), this.cache.set(e, t)), t;
        }
        getHct(e) {
            ...
            for (; e < t; ) {
                ...
                if (this.maxChroma(i) >= this.requestedChroma - 0.01)
                    if (Math.abs(e - 50) < Math.abs(t - 50)) t = i;
                        ...
                        if (e === i) return Jr.from(this.hue, this.requestedChroma, e);
                        e = i;
                    }
                else o ? (e = i + 1) : (t = i);
            }
    ...
    class ns {
        constructor(e, t, i, o) {
            (this.low = e), (this.normal = t), (this.medium = i), (this.high = o);
        }
        get(e) {
            return e <= -1
                ? this.low
    ...
    (cs.contentAccentToneDelta = 15),
        ...
        (cs.surfaceDim = ts.fromPalette({
            name: "surface_dim",
            palette: (e) => e.neutralPalette,
            tone: (e) => (e.isDark ? 6 : new ns(87, 87, 80, 75).get(e.contrastLevel)),
            isBackground: !0,
        })),
        (cs.surfaceBright = ts.fromPalette({
            name: "surface_bright",
            palette: (e) => e.neutralPalette,
            tone: (e) => (e.isDark ? new ns(24, 24, 29, 34).get(e.contrastLevel) : 98),
            isBackground: !0,
        })),
        (cs.surfaceContainerLowest = ts.fromPalette({
            name: "surface_container_lowest",
            palette: (e) => e.neutralPalette,
            tone: (e) => (e.isDark ? new ns(4, 4, 2, 0).get(e.contrastLevel) : 100),
            isBackground: !0,
        })),
        ...
        (cs.shadow = ts.fromPalette({ name: "shadow", palette: (e) => e.neutralPalette, tone: (e) => 0 })),
        (cs.scrim = ts.fromPalette({ name: "scrim", palette: (e) => e.neutralPalette, tone: (e) => 0 })),
        ...
        (cs.primary = ts.fromPalette({
            ...
            toneDeltaPair: (e) => new rs(cs.primaryContainer, cs.primary, 10, "nearer", !1),
        })),
        ...
        (cs.primaryContainer = ts.fromPalette({
            ...
            palette: (e) => e.primaryPalette,
            tone: (e) => (as(e) ? e.sourceColorHct.tone : ls(e) ? (e.isDark ? 85 : 25) : e.isDark ? 30 : 90),
            isBackground: !0,
            background: (e) => cs.highestSurface(e),
            contrastCurve: new ns(1, 1, 3, 4.5),
            toneDeltaPair: (e) => new rs(cs.primaryContainer, cs.primary, 10, "nearer", !1),
        ...
        (cs.secondary = ts.fromPalette({
            ...
            background: (e) => cs.highestSurface(e),
            contrastCurve: new ns(3, 4.5, 7, 7),
            toneDeltaPair: (e) => new rs(cs.secondaryContainer, cs.secondary, 10, "nearer", !1),
        })),
                    ...
                    ? (function (e, t, i, o) {
                          ...
                          if (r.chroma < t) {
                              ...
                              for (; r.chroma < t; ) {
                                  ...
                                  Math.abs(s.chroma - t) < Math.abs(r.chroma - t) && (r = s),
        ...
        (cs.tertiary = ts.fromPalette({
            ...
            background: (e) => cs.highestSurface(e),
            contrastCurve: new ns(3, 4.5, 7, 7),
            toneDeltaPair: (e) => new rs(cs.tertiaryContainer, cs.tertiary, 10, "nearer", !1),
        })),
        ...
        (cs.error = ts.fromPalette({
            ...
            background: (e) => cs.highestSurface(e),
            contrastCurve: new ns(3, 4.5, 7, 7),
            toneDeltaPair: (e) => new rs(cs.errorContainer, cs.error, 10, "nearer", !1),
        })),
        ...
        (cs.primaryFixed = ts.fromPalette({
            ...
            background: (e) => cs.highestSurface(e),
            contrastCurve: new ns(1, 1, 3, 4.5),
            toneDeltaPair: (e) => new rs(cs.primaryFixed, cs.primaryFixedDim, 10, "lighter", !0),
        })),
        ...
        (cs.secondaryFixed = ts.fromPalette({
            ...
            background: (e) => cs.highestSurface(e),
            contrastCurve: new ns(1, 1, 3, 4.5),
            toneDeltaPair: (e) => new rs(cs.secondaryFixed, cs.secondaryFixedDim, 10, "lighter", !0),
        })),
        ...
        (cs.tertiaryFixed = ts.fromPalette({
            ...
            background: (e) => cs.highestSurface(e),
            contrastCurve: new ns(1, 1, 3, 4.5),
            toneDeltaPair: (e) => new rs(cs.tertiaryFixed, cs.tertiaryFixedDim, 10, "lighter", !0),
        })),
    ...
    class us {
        static quantize(e, t, i) {
            ...
            for (let t = 0; t < e.length; t++) {
                const i = e[t],
                    l = o.get(i);
                void 0 === l ? (a++, n.push(s.fromInt(i)), r.push(i), o.set(i, 1)) : o.set(i, l + 1);
            }
            const l = new Array();
            for (let e = 0; e < a; e++) {
                const t = r[e],
            ...
            for (let e = 0; e < 10; e++) {
                ...
                for (let e = 0; e < a; e++) {
                    ...
                    if (-1 !== h) {
                        Math.abs(Math.sqrt(l) - Math.sqrt(a)) > 3 && (t++, (u[e] = h));
                    }
                }
                if (0 === t && 0 !== e) break;
                ...
                for (let e = 0; e < a; e++) {
                    const t = u[e],
                        s = n[e],
                        a = l[e];
                    (f[t] += a), (i[t] += s[0] * a), (o[t] += s[1] * a), (r[t] += s[2] * a);
                }
                for (let e = 0; e < c; e++) {
                    const t = f[e];
                    if (0 === t) {
    ...
    class ws {
        ...
        createBoxes(e) {
            ...
            for (let n = 1; n < e; n++) {
                this.cut(this.cubes[o], this.cubes[n])
                    ? ((t[o] = this.cubes[o].vol > 1 ? this.variance(this.cubes[o]) : 0),
                      (t[n] = this.cubes[n].vol > 1 ? this.variance(this.cubes[n]) : 0))
                    : ((t[o] = 0), n--),
                    (o = 0);
                let e = t[0];
        ...
        createResult(e) {
            ...
            for (let i = 0; i < e; ++i) {
                ...
                if (o > 0) {
                    const i =
                        (255 << 24) |
                        ((255 & Math.round(this.volume(e, this.momentsR) / o)) << 16) |
                        ((255 & Math.round(this.volume(e, this.momentsG) / o)) << 8) |
        ...
        cut(e, t) {
            ...
            switch (((t.r1 = e.r1), (t.g1 = e.g1), (t.b1 = e.b1), c)) {
                case gs:
                    (e.r1 = s.cutLocation), (t.r0 = e.r1), (t.g0 = e.g0), (t.b0 = e.b0);
                    break;
                case bs:
                    (e.g1 = a.cutLocation), (t.r0 = e.r0), (t.g0 = e.g1), (t.b0 = e.b0);
                    break;
                case ys:
                    (e.b1 = l.cutLocation), (t.r0 = e.r0), (t.g0 = e.g0), (t.b0 = e.b1);
                    break;
                default:
    ...
    class Es {
        constructor() {}
        static score(e, t) {
            const { desired: i, fallbackColorARGB: o, filter: n } = { ...Is, ...t },
                r = [],
            ...
            for (const e of r) {
                ...
                if (n && (e.chroma < Es.CUTOFF_CHROMA || t <= Es.CUTOFF_EXCITED_PROPORTION)) continue;
                const i = 100 * t * Es.WEIGHT_PROPORTION,
                    o = e.chroma < Es.TARGET_CHROMA ? Es.WEIGHT_CHROMA_BELOW : Es.WEIGHT_CHROMA_ABOVE,
            ...
            for (let e = 90; e >= 15; e--) {
                ...
                for (const { hct: t } of c) {
                    if ((d.find((i) => Dr(t.hue, i.hue) < e) || d.push(t), d.length >= i)) break;
                }
                if (d.length >= i) break;
            }
            const h = [];
    ...
    function Ts(e) {
        ...
        return (
            t
                ...
                : i
                ? ((n = Ds(e.slice(0, 2))), (r = Ds(e.slice(2, 4))), (s = Ds(e.slice(4, 6))))
                : o && ((n = Ds(e.slice(2, 4))), (r = Ds(e.slice(4, 6))), (s = Ds(e.slice(6, 8)))),
            ((255 << 24) | ((255 & n) << 16) | ((255 & r) << 8) | (255 & s)) >>> 0
        );
    }
    function Ds(e) {
    ...
    const Bs = (e) => {
            ...
            let i = t
                ...
                .flat();
            (i = L(i).filter((e) => e.startsWith(Ls))), t.removeClass(i.join(" "));
        ...
        Os = (e, t) => {
            ...
            const a = (e, t) =>
                    Object.entries(r[e])
                        .map(([e, i]) => t(k(e), ((e) => [Or(e), zr(e), Nr(e)].join(", "))(i)))
                        .join(""),
                l = Ls + `${e}-${_s++}`,
            ...
            Bs(o), M(i.head).append(`<style id="${l}">${c}</style>`), o.addClass(l);
        },
    ...
    (e.$ = M),
        ...
        (e.confirm = (e) => {
            const t = Object.assign(
                    {},
                    { confirmText: xr(), cancelText: $r(), onConfirm: x, onCancel: x },
                    e
                ),
                i = [
                    "headline",
            ...
            return new Promise((o, n) => {
                ...
                const s = kr({
                    ...Object.fromEntries(i.filter((e) => !u(t[e])).map((e) => [e, t[e]])),
                    actions: [
                        { text: t.cancelText, onClick: (e) => t.onCancel.call(e, e) },
                        {
                            text: t.confirmText,
                            onClick: (e) => {
                                const i = t.onConfirm.call(e, e);
        ...
        (e.getColorFromImage = async (e) => {
                ...
                i = await (async function (e) {
                    const t = await new Promise((t, i) => {
                            const o = document.createElement("canvas"),
                                n = o.getContext("2d");
                            if (!n) return void i(new Error("Could not get canvas context"));
                            const r = () => {
                                    (o.width = e.width), (o.height = e.height), n.drawImage(e, 0, 0);
                                    let i = [0, 0, e.width, e.height];
                                    const r = e.dataset.area;
                                    r &&
                                        /^\d+(\s*,\s*\d+){3}$/.test(r) &&
                                        (i = r.split(/\s*,\s*/).map((e) => parseInt(e, 10)));
                                    const [s, a, l, c] = i;
                            ...
                            e.complete ? r() : ((e.onload = r), (e.onerror = s));
                        }),
                        i = [];
            ...
            return (function (e) {
                ...
                for (const [e, t] of n.entries()) 1 === t.length && (n[e] = "0" + t);
                return "#" + n.join("");
            })(i);
        }),
        (e.getLocale = () => {
        ...
        (e.loadLocale = (e) => {
            ((e) => {
                const t = s(),
                    i = Zo({ sourceLocale: "en-us", targetLocales: nn, loadLocale: e });
                (sn = i.getLocale),
                    (an = i.setLocale),
                    t.addEventListener(Po, (e) => {
                        t.dispatchEvent(new CustomEvent("mdui-localize-status", { detail: e.detail }));
                    });
            })(e);
        }),
        (e.observeResize = Ti),
            ...
            return (
                ...
                new Promise((e, r) => {
                    ...
                    const a = kr({
                        ...
                        body: n,
                        actions: [
                            { text: i.cancelText, onClick: (e) => i.onCancel.call(e, n.value, e) },
                            {
                                text: i.confirmText,
                                onClick: (e) => {
                                    if ((n.setCustomValidity(""), !n.reportValidity())) return !1;
                                    ...
                                    return h(t) && !t
                                        ...
                                        : (() => {
                                              const t = i.onConfirm.call(e, n.value, e);
                                              return (
                                                  mr(t)
                                                      ? t.then(() => {
                                                            s = !0;
            ...
            return (
                Object.entries(t).forEach(([e, n]) => {
                    if ("message" === e) i.innerHTML = n;
                        ...
                        ["onClick", "onActionClick", "onOpen", "onOpened", "onClose", "onClosed"].includes(e)
                    ) {
                        const r = k(e.slice(2));
                        o.on(r, (o) => {
                            if (o.target === i)
                ...
                o.appendTo("body").on("closed", (e) => {
                    e.target === i && (o.remove(), t.queue && ((Ns = void 0), gr(zs + t.queue)));
                }),
                t.queue
                    ? Ns
                        ? vr(zs + t.queue, () => {
